        ...
        <div class="dm-mega-card">
            <div class="dm-mega-body">
                <div class="dm-mega-left">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="dm-mega-left-cta">
                        Book a Consultation
                ...
                <div class="dm-mega-center">
                    ...
                    <div class="dm-svc-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $navServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('service.show', $svc->slug)); ?>" class="dm-svc-card" tabindex="-1" data-mf>
                            <div class="dm-svc-icon">
                                <i class="fa-solid <?php echo e($svcIcons[$i % count($svcIcons)]); ?>"></i>
                            </div>
                            <div style="flex:1;min-width:0;">
                                <div class="dm-svc-title"><?php echo e($svc->title); ?></div>
                                <?php if(!empty($svc->short_description)): ?>
                                <div class="dm-svc-desc"><?php echo e(Str::limit($svc->short_description, 80)); ?></div>
                                <?php endif; ?>
                            </div>
            ...
            <div class="dm-mega-foot">
                ...
                <div class="dm-foot-pills">
                    <?php $__currentLoopData = $navServices->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('service.show', $pill->slug)); ?>" class="dm-foot-pill" tabindex="-1" data-mf>
                        <i class="fa-solid fa-circle-dot" style="font-size:9px;opacity:.6;"></i>
                        <?php echo e(Str::limit($pill->title, 28)); ?>

                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('contact')); ?>" class="dm-foot-pill" tabindex="-1" data-mf>
        ...
        <div class="dm-mega-card">
            <div class="dm-mega-body">
                <div class="dm-mega-left">
                    ...
                    <a href="<?php echo e(route('newsletter.index')); ?>" class="dm-mega-left-cta">
                ...
                <div class="dm-mega-center">
                    ...
                    <div class="dm-ins-grid">
                        <a href="<?php echo e(route('newsletter.index')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('report.index')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('case-study.index')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('alert.index')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('blog.index')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('cost-calculator')); ?>" class="dm-ins-card" tabindex="-1" data-mf>
                ...
                <div class="dm-mega-right">
                    ...
                    <ul class="dm-quick-links">
                        <li>
                            <a href="<?php echo e(route('alert.index')); ?>" tabindex="-1" data-mf>
                        ...
                        <li>
                            <a href="<?php echo e(route('newsletter.index')); ?>" tabindex="-1" data-mf>
                                <span class="dm-ql-dot"><i class="fa-solid fa-building" style="font-size:11px;"></i></span>Corporate Governance
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('blog.index')); ?>" tabindex="-1" data-mf>
            ...
            <div class="dm-mega-foot">
                ...
                <div class="dm-foot-pills">
                    <a href="<?php echo e(route('newsletter.index')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-envelope" style="font-size:10px;opacity:.7;"></i> Newsletters</a>
                    <a href="<?php echo e(route('report.index')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-file-lines" style="font-size:10px;opacity:.7;"></i> Reports</a>
                    <a href="<?php echo e(route('alert.index')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-bell" style="font-size:10px;opacity:.7;"></i> Latest Alerts</a>
                    <a href="<?php echo e(route('blog.index')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-rss" style="font-size:10px;opacity:.7;"></i> Blog</a>
                    <a href="<?php echo e(route('cost-calculator')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-calculator" style="font-size:10px;opacity:.7;"></i> Calculator</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="dm-mega-card">
            <div class="dm-mega-body">
                ...
                <div class="dm-mega-center">
                    ...
                    <div class="dm-svc-grid">
                        <a href="<?php echo e(route('events')); ?>" class="dm-svc-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('careers')); ?>" class="dm-svc-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="dm-svc-card" tabindex="-1" data-mf>
                        ...
                        <a href="<?php echo e(route('about')); ?>" class="dm-svc-card" tabindex="-1" data-mf>
                ...
                <div class="dm-mega-right">
                    ...
                    <ul class="dm-quick-links">
                        ...
                        <li>
                            <a href="<?php echo e(route('bookmarks')); ?>" tabindex="-1" data-mf>
                                <span class="dm-ql-dot"><i class="fa-solid fa-bookmark" style="font-size:11px;"></i></span>Resources Hub
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('privacy-policy')); ?>" tabindex="-1" data-mf>
            ...
            <div class="dm-mega-foot">
                ...
                <div class="dm-foot-pills">
                    <a href="<?php echo e(route('events')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-calendar-days" style="font-size:10px;opacity:.7;"></i> Events</a>
                    <a href="<?php echo e(route('careers')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-briefcase" style="font-size:10px;opacity:.7;"></i> Careers</a>
                    <a href="<?php echo e(route('contact')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-envelope" style="font-size:10px;opacity:.7;"></i> Contact</a>
                    <a href="<?php echo e(route('about')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-building" style="font-size:10px;opacity:.7;"></i> About Us</a>
                    <a href="<?php echo e(route('cost-calculator')); ?>" class="dm-foot-pill" tabindex="-1" data-mf><i class="fa-solid fa-calculator" style="font-size:10px;opacity:.7;"></i> Calculator</a>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>