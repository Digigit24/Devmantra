<?php $__env->startSection('title', $newsletter->meta_title ?: $newsletter->title); ?>
<?php $__env->startSection('meta_description', $newsletter->meta_description ?? $newsletter->excerpt ?? Str::limit(strip_tags($newsletter->content), 160)); ?>
<?php $__env->startSection('og_type', 'article'); ?>
<?php $newsletterOg = $newsletter->og_image ?: ($newsletter->featured_image ?: null); ?>
<?php if($newsletterOg): ?>
<?php $__env->startSection('og_image', $newsletterOg); ?>
<?php endif; ?>
<?php if($newsletter->canonical_url): ?>
<?php $__env->startSection('canonical_url', $newsletter->canonical_url); ?>
<?php endif; ?>
<?php if($newsletter->noindex): ?>
<?php $__env->startSection('noindex', '1'); ?>
<?php endif; ?>

<?php $__env->startPush('schema'); ?>
<?php echo \App\Services\SchemaService::newsletterSchema($newsletter); ?>
...
<?php $__env->stopPush(); ?>
<?php if($newsletter->custom_head): ?>
<?php $__env->startPush('custom_head'); ?>
<?php echo $newsletter->custom_head; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-meta tp_fade_anim" data-delay=".3">
                    ...
                    <?php if($newsletter->edition_label): ?>
                    <span class="dm-article-meta-item"><?php echo e($newsletter->edition_label); ?></span>
                    <?php endif; ?>
                    <span class="dm-article-meta-item"><?php echo e($newsletter->published_at?->format('M d, Y') ?? $newsletter->created_at->format('M d, Y')); ?></span>
                ...
                <h1 class="dm-article-hero-title tp-text-revel-anim" data-delay=".5"><?php echo e($newsletter->title); ?></h1>
    ...
    <div class="container container-1230">
        <div class="row justify-content-center">
            <div class="col-lg-10">
              ...
              <img src="<?php echo e(asset('storage/' . $newsletter->featured_image)); ?>" alt="<?php echo e($newsletter->title); ?>" loading="lazy">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div style="margin:40px 0 0;">
                    <a href="<?php echo e($newsletter->button_url); ?>" target="_blank" rel="noopener noreferrer" style="
                    ...
                    " onmouseover="this.style.opacity='.75'" onmouseout="this.style.opacity='1'">
                        <?php echo e($newsletter->button_text ?: 'Read More'); ?>
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        <a href="<?php echo e(route('newsletter.index')); ?>">Newsletter</a>
                        <?php if($newsletter->edition_label): ?>
                        <a href="<?php echo e(route('newsletter.index')); ?>"><?php echo e($newsletter->edition_label); ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($newsletter->title)); ?>" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <div class="col-lg-4">
                <div class="dm-sidebar">
                    ...
                    <?php $__currentLoopData = $sidebarNewsletters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidePost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dm-sidebar-post">
                        <div class="dm-sidebar-post-thumb">
                            <?php if($sidePost->featured_image): ?>
                                <a href="<?php echo e(route('newsletter.show', $sidePost->slug)); ?>">
                         ...
                         <!-- <div class="dm-sidebar-post-thumb">
                            <?php if($sidePost->featured_image): ?>
                                <a href="<?php echo e(route('newsletter.show', $sidePost->slug)); ?>">
                                    <img src="<?php echo e(asset('storage/' . $sidePost->featured_image)); ?>" alt="<?php echo e($sidePost->title); ?>" loading="lazy">
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('newsletter.show', $sidePost->slug)); ?>">
                                    <img src="<?php echo e(asset('assets/img/home-13/blog/blog-thumb-' . (($loop->index % 3) + 1) . '.jpg')); ?>" alt="<?php echo e($sidePost->title); ?>">
                        ...
                        <div class="dm-sidebar-post-info">
                            <span class="dm-sidebar-post-category">
                                <?php echo e($sidePost->edition_label ?? 'Newsletter'); ?>

                            </span>
                            <h5 class="dm-sidebar-post-title">
                                <a href="<?php echo e(route('newsletter.show', $sidePost->slug)); ?>"><?php echo e($sidePost->title); ?></a>
                            </h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-related-card tp_fade_anim" data-delay=".<?php echo e(3 + ($loop->index * 2)); ?>">
                    <div class="dm-related-card-thumb">
                        <a href="<?php echo e(route('newsletter.show', $post->slug)); ?>">
                           <?php if($post->featured_image): ?>
                                <img src="<?php echo e(Str::startsWith($post->featured_image, 'http') ? $post->featured_image : asset('storage/' . $post->featured_image)); ?>" alt="<?php echo e($post->title); ?>" loading="lazy">
                            <?php else: ?>
                                <img src="<?php echo e(asset('assets/img/home-13/blog/blog-thumb-' . (($loop->index % 3) + 1) . '.jpg')); ?>" alt="<?php echo e($post->title); ?>">
                            <?php endif; ?>
                        </a>
                    </div>
                    <span class="dm-related-card-category"><?php echo e($post->edition_label ?? 'Newsletter'); ?></span>
                    <h4 class="dm-related-card-title">
                        <a href="<?php echo e(route('newsletter.show', $post->slug)); ?>"><?php echo e($post->title); ?></a>
                    </h4>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\newsletter-detail.blade.php ENDPATH**/ ?>