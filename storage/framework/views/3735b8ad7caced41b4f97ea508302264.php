...
<?php if (! $__env->hasRenderedOnce('77a00884-1c22-4bf3-86ec-d543760db99a')): $__env->markAsRenderedOnce('77a00884-1c22-4bf3-86ec-d543760db99a'); ?>
...
<section class="ss-trust">
    <div class="container container-1230" style="position:relative;z-index:1;">
        <h2 class="ss-trust-title tp_fade_anim" data-delay=".2"><?php echo e($title); ?></h2>
        <div class="ss-trust-grid tp_fade_anim" data-delay=".3">
            ...
            <div class="ss-trust-item">
                ...
                <span class="ss-trust-label"><?php echo e($item['label'] ?? ''); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views/components/service-sections/trust-signals.blade.php ENDPATH**/ ?>