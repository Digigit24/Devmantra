<?php $__env->startSection('title', $career->title . ' - Careers - DevMantra'); ?>
<?php $__env->startSection('meta_description', $career->meta_description ?? Str::limit(strip_tags($career->description), 160)); ?>
...
<style>
    ...
    .dm-apply-success {
        ...
        color: #1d6aa9; padding: 16px 20px; border-radius: 10px;
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="tp-section-subtitle-gradient ct mb-20 tp_fade_anim" data-delay=".3">
                    <a href="<?php echo e(route('careers')); ?>" style="color:inherit;text-decoration:none;">Careers</a>
                </div>
                <h1 class="dm-career-hero-title tp-text-revel-anim" data-delay=".5"><?php echo e($career->title); ?></h1>
                <div class="dm-career-hero-meta tp_fade_anim" data-delay=".7">
                    <?php if($career->location): ?>
                    <span><i class="fa-solid fa-location-dot"></i> <?php echo e($career->location); ?></span>
                    <?php endif; ?>
                    <span><i class="fa-solid fa-briefcase"></i> <?php echo e($career->type); ?></span>
                    <span><i class="fa-solid fa-calendar"></i> <?php echo e($career->published_at?->format('M d, Y')); ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="dm-apply-wrap tp_fade_anim" data-delay=".5">
                    ...
                    <form method="POST" action="<?php echo e(route('career.apply', $career->slug)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="dm-apply-group">
                            <label class="dm-apply-label">Full Name *</label>
                            <input type="text" name="name" class="dm-apply-input" placeholder="Your full name" value="<?php echo e(old('name')); ?>" required>
                            <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="dm-apply-error"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="dm-apply-group">
                            ...
                            <input type="email" name="email" class="dm-apply-input" placeholder="your@email.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="dm-apply-group">
                            ...
                            <input type="text" name="phone" class="dm-apply-input" placeholder="+91 XXXXX XXXXX" value="<?php echo e(old('phone')); ?>">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\career-detail.blade.php ENDPATH**/ ?>