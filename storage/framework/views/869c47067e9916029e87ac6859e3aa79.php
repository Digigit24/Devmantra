      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#ffffff;padding:40px;">
            ...
            <p style="margin:0 0 20px;font-size:16px;color:#1a1a2e;font-weight:500;">Hi <?php echo e($name); ?>,</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border:1px solid #e8ecf0;border-radius:10px;margin-bottom:32px;">
              <tr>
                <td style="padding:20px 24px;border-bottom:1px solid #e8ecf0;">
                  ...
                  <p style="margin:0;font-size:15px;color:#1a1a2e;font-weight:500;"><?php echo e($enquirySubject); ?></p>
                </td>
              </tr>
              <tr>
                <td style="padding:20px 24px;">
                  ...
                  <p style="margin:0;font-size:14px;color:#555;line-height:1.7;white-space:pre-line;"><?php echo e($userMessage); ?></p>
                </td>
              </tr>
            </table>
...
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\emails\contact-user.blade.php ENDPATH**/ ?>