            ...
            <div class="dm-table-wrap" style="padding:28px;margin-bottom:20px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="color-pair">
                            <input type="color" id="brandFromPicker" name="brand_color_from"
                                   value="<?php echo e($settings['brand_color_from'] ?? '#1b3c6b'); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="color-pair">
                            <input type="color" id="brandToPicker" name="brand_color_to"
                                   value="<?php echo e($settings['brand_color_to'] ?? '#4a73c4'); ?>">
                ...
                <div style="margin-top:14px;">
                    ...
                    <div id="gradientPreview" class="gradient-preview"
                         style="background:linear-gradient(135deg,<?php echo e($settings['brand_color_from'] ?? '#1b3c6b'); ?>,<?php echo e($settings['brand_color_to'] ?? '#4a73c4'); ?>);"></div>
                </div>
            </div>
            ...
            <div class="dm-table-wrap" style="padding:28px;margin-bottom:20px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="primary_button_text" class="dm-form-input"
                           value="<?php echo e($settings['primary_button_text'] ?? 'Book a Free Consultation'); ?>"
                ...
                <div class="dm-form-group" style="margin-bottom:0;">
                    ...
                    <input type="text" name="primary_button_url" class="dm-form-input"
                           value="<?php echo e($settings['primary_button_url'] ?? '/contact'); ?>"
            ...
            <div class="dm-table-wrap" style="padding:28px;margin-bottom:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="secondary_button_text" class="dm-form-input"
                           value="<?php echo e($settings['secondary_button_text'] ?? 'Get a Financial Review'); ?>"
                ...
                <div class="dm-form-group" style="margin-bottom:0;">
                    ...
                    <input type="text" name="secondary_button_link" class="dm-form-input"
                           value="<?php echo e($settings['secondary_button_link'] ?? ''); ?>"
                ...
                <label style="display:flex;align-items:center;gap:14px;cursor:pointer;user-select:none;">
                    ...
                    <div style="position:relative;width:44px;height:24px;flex-shrink:0;">
                        <input type="checkbox" id="btn_new_tab_toggle" name="button_new_tab" value="1"
                               <?php echo e(($settings['button_new_tab'] ?? '1') == '1' ? 'checked' : ''); ?>
                        ...
                        <span id="btn_new_tab_track"
                              style="position:absolute;inset:0;border-radius:12px;transition:background 0.2s;cursor:pointer;
                                     background:<?php echo e(($settings['button_new_tab'] ?? '1') == '1' ? '#1b3c6b' : '#cbd5e1'); ?>;"></span>
                        <span id="btn_new_tab_thumb"
                              style="position:absolute;top:3px;width:18px;height:18px;border-radius:50%;background:#fff;
                                     ...
                                     left:<?php echo e(($settings['button_new_tab'] ?? '1') == '1' ? '23px' : '3px'); ?>;"></span>
                    </div>
            ...
            <div class="dm-table-wrap" style="padding:28px;margin-bottom:24px;">
                    ...
                    <div class="col-md-8">
                        <div class="dm-form-group">
                            ...
                            <input type="text" name="seo_default_title" class="dm-form-input"
                                   value="<?php echo e($settings['seo_default_title'] ?? ''); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="dm-form-group">
                            ...
                            <input type="text" name="seo_title_separator" class="dm-form-input"
                                   value="<?php echo e($settings['seo_title_separator'] ?? '—'); ?>"
                ...
                <div class="dm-form-group">
                    ...
                    <textarea name="seo_default_description" class="dm-form-textarea" style="min-height:70px;"
                              maxlength="160"
                              placeholder="A concise description of your website for search engines…"><?php echo e($settings['seo_default_description'] ?? ''); ?></textarea>
                ...
                <div class="dm-form-group">
                    ...
                    <input type="url" name="seo_default_og_image" class="dm-form-input"
                           value="<?php echo e($settings['seo_default_og_image'] ?? ''); ?>"
                    ...
                    <div class="col-md-6">
                        <div class="dm-form-group">
                            ...
                            <input type="text" name="seo_google_verification" class="dm-form-input"
                                   value="<?php echo e($settings['seo_google_verification'] ?? ''); ?>"
                    ...
                    <div class="col-md-6">
                        <div class="dm-form-group">
                            ...
                            <select name="seo_robots_mode" class="dm-form-select">
                                <option value="index"   <?php echo e(($settings['seo_robots_mode'] ?? 'index') === 'index'   ? 'selected' : ''); ?>>index, follow (default)</option>
                                <option value="noindex" <?php echo e(($settings['seo_robots_mode'] ?? 'index') === 'noindex' ? 'selected' : ''); ?>>noindex, nofollow (hide from search)</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="dm-form-group" style="margin-bottom:0;">
                            ...
                            <input type="text" name="seo_ga4_id" class="dm-form-input"
                                   value="<?php echo e($settings['seo_ga4_id'] ?? ''); ?>"
                    ...
                    <div class="col-md-6">
                        <div class="dm-form-group" style="margin-bottom:0;">
                            ...
                            <input type="text" name="seo_gtm_id" class="dm-form-input"
                                   value="<?php echo e($settings['seo_gtm_id'] ?? ''); ?>"
    ...
    <div class="col-lg-4">
        ...
        <div class="dm-table-wrap" style="padding:24px;margin-bottom:20px;">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;align-items:flex-start;">
                <a href="#" onclick="return false;"
                   style="display:inline-flex;align-items:center;gap:8px;padding:11px 20px;background:linear-gradient(135deg,<?php echo e($settings['brand_color_from'] ?? '#1b3c6b'); ?>,<?php echo e($settings['brand_color_to'] ?? '#4a73c4'); ?>);color:#fff;font-size:13px;font-weight:600;border-radius:30px;text-decoration:none;">
                    <?php echo e($settings['primary_button_text'] ?? 'Book a Free Consultation'); ?>

                </a>
                <?php if(!empty($settings['secondary_button_link'])): ?>
                <a href="#" onclick="return false;"
                   style="display:inline-flex;align-items:center;gap:8px;padding:11px 20px;background:linear-gradient(135deg,<?php echo e($settings['brand_color_from'] ?? '#1b3c6b'); ?>,<?php echo e($settings['brand_color_to'] ?? '#4a73c4'); ?>);color:#fff;font-size:13px;font-weight:600;border-radius:30px;text-decoration:none;">
                    <?php echo e($settings['secondary_button_text'] ?? 'Get a Financial Review'); ?>
        ...
        <div class="dm-table-wrap" style="padding:24px;margin-bottom:20px;">
            ...
            <table style="width:100%;font-size:13px;">
                <tr><td style="padding:5px 0;color:#64748b;">Laravel</td><td style="padding:5px 0;text-align:right;font-weight:600;"><?php echo e(app()->version()); ?></td></tr>
                <tr><td style="padding:5px 0;color:#64748b;">PHP</td><td style="padding:5px 0;text-align:right;font-weight:600;"><?php echo e(phpversion()); ?></td></tr>
                <tr><td style="padding:5px 0;color:#64748b;">Database</td><td style="padding:5px 0;text-align:right;font-weight:600;"><?php echo e(config('database.default')); ?></td></tr>
                <tr><td style="padding:5px 0;color:#64748b;">Environment</td><td style="padding:5px 0;text-align:right;font-weight:600;"><?php echo e(app()->environment()); ?></td></tr>
            </table>
        </div>
        ...
        <div class="dm-table-wrap" style="padding:24px;">
            ...
            <a href="<?php echo e(route('admin.profile')); ?>" class="d-flex align-items-center gap-2 mb-3" style="font-size:14px;color:var(--dm-text);">
                <i class="fa-solid fa-user" style="width:16px;color:var(--dm-text-muted);"></i> Edit Profile
            </a>
            <a href="<?php echo e(route('admin.password')); ?>" class="d-flex align-items-center gap-2 mb-3" style="font-size:14px;color:var(--dm-text);">
                <i class="fa-solid fa-lock" style="width:16px;color:var(--dm-text-muted);"></i> Change Password
            </a>
            <a href="<?php echo e(route('admin.contact-settings.edit')); ?>" class="d-flex align-items-center gap-2 mb-3" style="font-size:14px;color:var(--dm-text);">
                <i class="fa-solid fa-address-book" style="width:16px;color:var(--dm-text-muted);"></i> Contact Settings
            </a>
            <a href="<?php echo e(url('/')); ?>" target="_blank" class="d-flex align-items-center gap-2" style="font-size:14px;color:var(--dm-text);">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\account\settings.blade.php ENDPATH**/ ?>