<?php $__env->startSection('title', 'Events - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Dev Mantra events, news coverage, and media highlights.'); ?>
    ...
    <div class="container container-1230" style="padding-left:0;padding-right:0;">
        <div class="dm-events-tabs-inner" role="tablist">
            <button class="dm-events-tab active" data-tab="all" role="tab" aria-selected="true">
                All
                <span class="dm-tab-count" id="count-all"><?php echo e($events->count()); ?></span>
            </button>
            <?php $__currentLoopData = $tagLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="dm-events-tab" data-tab="<?php echo e($value); ?>" role="tab" aria-selected="false">
                <i class="<?php echo e($tagIcons[$value]); ?>" style="font-size:12px;"></i>
                <?php echo e($label); ?>

                <span class="dm-tab-count" id="count-<?php echo e($value); ?>"><?php echo e($tagCounts[$value] ?? 0); ?></span>
            </button>
...
<div class="dm-events-all">
    <div class="container container-1230">
        ...
        <?php if($events->count()): ?>
            ...
            <div class="dm-event-section tp_fade_anim" data-delay=".3" data-tags="<?php echo e(json_encode($eventTags)); ?>">

                
                <div class="dm-event-body" id="body-<?php echo e($eventKey); ?>">

                    
                    <?php if($event->hero_image_url): ?>
                    <img class="dm-event-hero-img" src="<?php echo e($event->hero_image_url); ?>" alt="<?php echo e($event->title); ?>">
                    <?php endif; ?>
                    ...
                    <div class="dm-event-intro row align-items-start">
                        <div class="col-lg-7">
                            ...
                            <?php $__currentLoopData = $eventTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dm-event-tag-badge tag-<?php echo e($etag); ?>" style="margin-right:6px;">
                                <i class="<?php echo e($tagIcons[$etag] ?? 'fa-solid fa-tag'); ?>" style="font-size:10px;"></i>
                                <?php echo e($tagLabels[$etag] ?? $etag); ?>

                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <?php if($event->published_at): ?>
                            <div class="dm-event-section-date"><?php echo e($event->published_at->format('d M Y')); ?></div>
                            <?php endif; ?>
                            <a href="<?php echo e(route('event.show', $event->slug)); ?>" class="dm-event-section-title">
                            ...
                            <a href="<?php echo e(route('event.show', $event->slug)); ?>" class="dm-event-section-link mt-3">
                        ...
                        <div class="col-lg-5">
                            <div class="dm-event-featured-wrap">
                                <img src="<?php echo e($featuredSrc); ?>" alt="<?php echo e($event->title); ?>">
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="dm-masonry">
                        <?php $__currentLoopData = $event->galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $src = str_starts_with($img->image_path, 'http') ? $img->image_path : asset('storage/' . $img->image_path); ?>
                        <div class="dm-masonry-item"
                             onclick="dmLightbox.open('<?php echo e($eventKey); ?>', <?php echo e($idx); ?>)"
                             title="<?php echo e($event->title); ?> — image <?php echo e($idx + 1); ?>">
                            <img src="<?php echo e($src); ?>" alt="<?php echo e($event->title); ?> <?php echo e($idx + 1); ?>">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php endif; ?>
                ...
                <div class="dm-event-fade" id="fade-<?php echo e($eventKey); ?>"></div>

                
                <div class="dm-event-readmore-wrap" id="rm-<?php echo e($eventKey); ?>">
                    <button class="dm-event-readmore-btn"
                            onclick="dmToggleExpand('<?php echo e($eventKey); ?>', this)">
...
(function () {
    ...
    /* ── Lightbox ── */
    var registry = <?php echo json_encode($events->mapWithKeys(function ($event) {
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\event-index.blade.php ENDPATH**/ ?>