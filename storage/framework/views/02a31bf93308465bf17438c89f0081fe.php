<?php $__env->startSection('title', 'Typography Settings'); ?>

<?php $__env->startPush('styles'); ?>

<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link rel="stylesheet" href="<?php echo e(\App\Http\Controllers\Admin\TypographyController::allGoogleFontsUrl()); ?>">
<style>
.ty-section-title {
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        <form method="POST" action="<?php echo e(route('admin.typography.update')); ?>">
                ...
                <div class="ty-row">
                    ...
                    <div>
                        <select name="font_body" class="dm-form-input ty-select" data-preview="preview_body">
                            ...
                            <option value="<?php echo e($font['key']); ?>"
                                data-fallback="<?php echo e($font['fallback']); ?>"
                                <?php echo e(($settings['font_body'] ?? '') === $font['key'] ? 'selected' : ''); ?>>
                                <?php echo e($font['label']); ?>
                    ...
                    <div>
                        <div id="preview_body" class="ty-preview ty-preview-body"
                             style="font-family: '<?php echo e($settings['font_body'] ?? 'Inter'); ?>', sans-serif;">
                ...
                <div class="ty-row">
                    ...
                    <div>
                        <select name="font_p" class="dm-form-input ty-select" data-preview="preview_p">
                            ...
                            <option value="<?php echo e($font['key']); ?>"
                                data-fallback="<?php echo e($font['fallback']); ?>"
                                <?php echo e(($settings['font_p'] ?? '') === $font['key'] ? 'selected' : ''); ?>>
                                <?php echo e($font['label']); ?>
                    ...
                    <div>
                        <div id="preview_p" class="ty-preview ty-preview-p"
                             style="font-family: '<?php echo e($settings['font_p'] ?? 'Inter'); ?>', sans-serif;">
            ...
            <div class="dm-table-wrap" style="padding:28px;margin-bottom:24px;">
                ...
                <?php $__currentLoopData = [
                    ...
                    ['h5', 'H5', '17px'],
                    ['h6', 'H6', '14px'],
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$el, $tag, $size]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ty-row">
                    <div><span class="ty-tag"><?php echo e($tag); ?></span></div>
                    <div>
                        <select name="font_<?php echo e($el); ?>" class="dm-form-input ty-select" data-preview="preview_<?php echo e($el); ?>">
                            <option value="">-- Default (Inter) --</option>
                            <?php $__currentLoopData = $fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($font['key']); ?>"
                                data-fallback="<?php echo e($font['fallback']); ?>"
                                <?php echo e(($settings['font_'.$el] ?? '') === $font['key'] ? 'selected' : ''); ?>>
                                <?php echo e($font['label']); ?>
                    ...
                    <div>
                        <div id="preview_<?php echo e($el); ?>" class="ty-preview ty-preview-<?php echo e($el); ?>"
                             style="font-family: '<?php echo e($settings['font_'.$el] ?? 'Inter'); ?>', sans-serif; font-size: <?php echo e($size); ?>;">
                            <?php echo e($tag); ?> — Page Heading
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="dm-table-wrap" style="padding:24px;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.04);">
                <span style="font-size:13px;font-family:'<?php echo e($font['key']); ?>',<?php echo e($font['fallback']); ?>;">
                    <?php echo e($font['label']); ?>

                </span>
                <span class="ty-badge-<?php echo e($font['type']); ?>"><?php echo e($font['type']); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\account\typography.blade.php ENDPATH**/ ?>