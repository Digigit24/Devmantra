<?php $__env->startSection('title', 'Add Section — ' . $service->title); ?>
...
<form method="POST" action="<?php echo e(route('admin.services.sections.store', $service)); ?>" id="section-form">
    <?php echo csrf_field(); ?>
        ...
        <div class="ss-preview-wrap">
            ...
            <div class="ss-panel">
                ...
                <div class="ss-type-grid" id="type-grid">
                    ...
                    <div class="ss-type-card" data-type="<?php echo e($key); ?>" onclick="selectType('<?php echo e($key); ?>')">
                        <span class="ss-type-card-icon"><i class="<?php echo e($meta['schema'] ? 'fa-solid fa-layer-group' : 'fa-solid fa-layer-group'); ?>"></i></span>
            ...
            <div class="ss-preview-wrap" style="position:static;">
                ...
                <iframe name="preview-frame" id="preview-frame" class="ss-preview-iframe"
                    src="<?php echo e(route('admin.section-preview')); ?>?type=&data={}"></iframe>
            </div>
        </div>
    </div>
</form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\service-sections\create.blade.php ENDPATH**/ ?>