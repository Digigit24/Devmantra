<?php $__env->startSection('title', 'Contact Us - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Get in touch with Dev Mantra. We are here to help with your financial and advisory needs.'); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="dm-cf-error" style="margin-bottom:16px;"><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>

                    <form method="POST" action="<?php echo e(route('contact.submit')); ?>" id="contact-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="dm-cf-group">
                                    ...
                                    <input type="text" name="name" class="dm-cf-input" placeholder="Your full name" value="<?php echo e(old('name')); ?>" required>
                                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="dm-cf-error"><?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="dm-cf-group">
                                    ...
                                    <input type="email" name="email" class="dm-cf-input" placeholder="your@email.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="dm-cf-group">
                                    ...
                                    <input type="text" name="phone" class="dm-cf-input" placeholder="+91 XXXXX XXXXX" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="dm-cf-group">
                                    ...
                                    <input type="text" name="subject" class="dm-cf-input" placeholder="How can we help?" value="<?php echo e(old('subject')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="dm-cf-group">
                                    ...
                                    <textarea name="message" class="dm-cf-textarea" placeholder="Tell us about your project or inquiry..." required><?php echo e(old('message')); ?></textarea>
...
<!-- Social Media -->
<?php if($contact->facebook_url || $contact->twitter_url || $contact->linkedin_url || $contact->instagram_url || $contact->whatsapp_url): ?>
<div class="dm-contact-social">
    <div class="container container-1230">
        ...
        <div class="dm-contact-social-links tp_fade_anim" data-delay=".4">
            ...
            <a href="<?php echo e($contact->facebook_url); ?>" target="_blank" rel="noopener" class="dm-contact-social-link" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
            <?php endif; ?>
            <?php if($contact->twitter_url): ?>
            <a href="<?php echo e($contact->twitter_url); ?>" target="_blank" rel="noopener" class="dm-contact-social-link" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            <?php endif; ?>
            <?php if($contact->linkedin_url): ?>
            <a href="<?php echo e($contact->linkedin_url); ?>" target="_blank" rel="noopener" class="dm-contact-social-link" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
            <?php endif; ?>
            <?php if($contact->instagram_url): ?>
            <a href="<?php echo e($contact->instagram_url); ?>" target="_blank" rel="noopener" class="dm-contact-social-link" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
            <?php endif; ?>
            <?php if($contact->whatsapp_url): ?>
            <a href="<?php echo e($contact->whatsapp_url); ?>" target="_blank" rel="noopener" class="dm-contact-social-link" aria-label="WhatsApp"><i class="fa-brands fa-whatsapp"></i></a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<!-- Google Map -->
<?php if($contact->google_map_embed): ?>
<div class="dm-contact-map">
    <div class="container container-1230">
        <div class="dm-contact-map-wrap tp_fade_anim" data-delay=".3">
            <iframe src="<?php echo e($contact->google_map_embed); ?>" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\contact.blade.php ENDPATH**/ ?>