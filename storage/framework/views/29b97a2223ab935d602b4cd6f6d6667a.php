...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['url' => null, 'text' => null, 'class' => '']));
...
foreach (array_filter((['url' => null, 'text' => null, 'class' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
?>
<a href="<?php echo e($btnUrl); ?>" class="dm-btn-primary <?php echo e($class); ?>" target="<?php echo e($btnTarget); ?>" <?php if($btnRel): ?> rel="<?php echo e($btnRel); ?>" <?php endif; ?>>
    <?php echo e($btnText); ?>
...
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/components/btn-primary.blade.php ENDPATH**/ ?>