...
<form method="POST" action="<?php echo e(route('admin.case-studies.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
        <div class="col-lg-8">
        ...
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="category" value="<?php echo e(old('category', 'Case Study')); ?>" class="dm-form-input">
                </div>
                <div class="dm-form-group">
                ...
                <button type="submit" class="dm-btn dm-btn-primary w-100">
                    <i class="fa-solid fa-check"></i> Create Case Study
                </button>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\case-studies\create.blade.php ENDPATH**/ ?>