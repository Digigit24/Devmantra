<?php $__env->startSection('title', 'Section Library'); ?>
...
<div class="dm-table-wrap" style="padding: 28px;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:28px;flex-wrap:wrap;gap:12px;">
        <div>
            ...
            <p style="font-size:13px;color:#94a3b8;margin:0;">
                <?php echo e(count($sectionTypes)); ?> reusable section layouts available for service pages.
            </p>
        </div>
    ...
    <div class="lib-page-grid">
        <?php $__currentLoopData = $sectionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $label     = $meta['label'];
        ...
        <div class="lib-page-card">
            ...
            <div class="lib-page-preview">
                <?php echo $wf[$key] ?? '<div class="wf"><div class="wf-h" style="width:60%;"></div><div class="wf-bar" style="width:100%;"></div><div class="wf-bar" style="width:80%;"></div></div>'; ?>
            ...
            <div class="lib-page-body">
                <div class="lib-page-meta">
                    <div class="lib-page-icon-chip"><i class="<?php echo e($icon); ?>"></i></div>
                    <code class="lib-page-type-key"><?php echo e($key); ?></code>
                </div>

                <div class="lib-page-name-short"><?php echo e($shortName); ?></div>
                <?php if($subName): ?>
                    <div class="lib-page-name-sub"><?php echo e($subName); ?></div>
                <?php endif; ?>

                <?php if($fields): ?>
                <div class="lib-page-fields">
                    <?php $__currentLoopData = array_slice($fields, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="lib-page-field"><?php echo e($field); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(count($fields) > 5): ?>
                        <span class="lib-page-field more">+<?php echo e(count($fields) - 5); ?> more</span>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\sections\library.blade.php ENDPATH**/ ?>