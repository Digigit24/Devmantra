...
<form method="POST" action="<?php echo e(route('admin.newsletters.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
        <div class="col-lg-8">
        ...
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="edition_label" value="<?php echo e(old('edition_label')); ?>" class="dm-form-input" placeholder="e.g. February 2025">
                </div>
                <div class="dm-form-group">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="url" name="button_url" value="<?php echo e(old('button_url')); ?>" class="dm-form-input" placeholder="https://example.com/newsletter.pdf">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="button_text" value="<?php echo e(old('button_text', 'Read More')); ?>" class="dm-form-input" placeholder="Read More">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home2/devmasjc/devmantra/resources/views/admin/newsletters/create.blade.php ENDPATH**/ ?>