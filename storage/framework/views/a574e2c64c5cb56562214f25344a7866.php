<?php $__env->startSection('title', $caseStudy->title . ' - DevMantra'); ?>
...
<?php $__env->startSection('og_image', asset('storage/' . $caseStudy->featured_image)); ?>
<?php endif; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-featured-img tp_fade_anim" data-delay=".3">
                    <img src="<?php echo e(asset('storage/' . $caseStudy->featured_image)); ?>" alt="<?php echo e($caseStudy->title); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home2/devmasjc/devmantra/resources/views/frontend/case-study-detail.blade.php ENDPATH**/ ?>