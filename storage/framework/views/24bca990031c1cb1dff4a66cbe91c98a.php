<?php $__env->startSection('title', 'About Us - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Dev Mantra is an audit-grade, CA-led India execution partner for cross-border M&A, India entry, Virtual CFO and GCC setup. Founded in 2008 in Bengaluru.'); ?>
...
<?php echo \App\Services\SchemaService::faqSchema($dmFaqs); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
                ...
                <div class="dm-faq-list">
                    <?php $__currentLoopData = $dmFaqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <details class="dm-faq-item" style="background:#fff; border:1px solid #e6ebf2; border-radius:14px; padding:22px 26px; margin-bottom:16px; box-shadow:0 2px 14px rgba(0,29,48,.04);" <?php echo e($i === 0 ? 'open' : ''); ?>>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\about.blade.php ENDPATH**/ ?>