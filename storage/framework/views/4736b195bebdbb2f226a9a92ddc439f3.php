<?php $__env->startSection('title', 'Careers - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Join the DevMantra team. Explore current openings and apply for roles that match your expertise.'); ?>
...
<style>
    ...
    .dm-job-type-full-time { background: rgba(34,197,94,0.1); color: #1d6aa9; }
    ...
    <div class="container container-1230">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-job-card tp_fade_anim" data-delay=".<?php echo e(3 + ($loop->index % 3)); ?>" style="margin-bottom:30px;">
                    <span class="dm-job-card-type <?php echo e($typeClasses[$career->type] ?? 'dm-job-type-full-time'); ?>"><?php echo e($career->type); ?></span>
                    <h4 class="dm-job-card-title">
                        <a href="<?php echo e(route('career.show', $career->slug)); ?>"><?php echo e($career->title); ?></a>
                    </h4>
                    ...
                    <a href="<?php echo e(route('career.show', $career->slug)); ?>" class="dm-job-card-link">
                        View Details
        ...
        <?php if($careers->hasPages()): ?>
            <?php echo e($careers->links('vendor.pagination.devmantra')); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\careers-index.blade.php ENDPATH**/ ?>