<?php $__env->startSection('title', 'Edit Section — ' . $service->title); ?>

<?php $__env->startSection('actions'); ?>
<a href="<?php echo e(route('admin.services.sections.index', $service)); ?>" class="dm-btn dm-btn-outline dm-btn-sm">
...
<form method="POST" action="<?php echo e(route('admin.services.sections.update', [$service, $section])); ?>" id="section-form">
    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
    <input type="hidden" name="section_type" id="hidden-type" value="<?php echo e($section->section_type); ?>">
    <input type="hidden" name="section_data" id="hidden-data" value="{}">
    <input type="hidden" name="sort_order" id="hidden-order" value="<?php echo e($section->sort_order); ?>">
    <input type="hidden" name="is_active" id="hidden-active" value="<?php echo e($section->is_active ? '1' : '0'); ?>">
        ...
        <div class="ss-preview-wrap">
            ...
            <div class="ss-panel">
                ...
                <div class="ss-type-grid" id="type-grid">
                    ...
                    <div class="ss-type-card <?php echo e($section->section_type === $key ? 'selected' : ''); ?>"
                         data-type="<?php echo e($key); ?>" onclick="selectType('<?php echo e($key); ?>', false)">
                        <span class="ss-type-card-icon"><i class="fa-solid fa-layer-group"></i></span>
                        <span class="ss-type-card-name"><?php echo e(explode(' — ', $meta['label'])[0]); ?></span>
                    </div>
            ...
            <div class="ss-panel">
                ...
                <div class="ss-setting-row">
                    ...
                    <input type="number" id="sort-order-input" value="<?php echo e($section->sort_order); ?>" class="dm-form-input" style="width:90px;text-align:center;">
                </div>
                <div class="ss-setting-row" style="margin-bottom:0;">
                    <label class="ss-setting-label">Active</label>
                    <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
                        <input type="checkbox" id="active-checkbox" <?php echo e($section->is_active ? 'checked' : ''); ?> style="accent-color:#1b3c6b;width:16px;height:16px;">
...
let currentType = '<?php echo e($section->section_type); ?>';
const existingData = <?php echo json_encode($section->section_data ?? [], 15, 512) ?>;
...
function selectType(type, loadEmpty) {
    ...
    const data = (loadEmpty === false && type === '<?php echo e($section->section_type); ?>') ? existingData : {};
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\service-sections\edit.blade.php ENDPATH**/ ?>