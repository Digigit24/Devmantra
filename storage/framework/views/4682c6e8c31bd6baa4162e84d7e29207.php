<?php $__env->startSection('title', $event->meta_title ?: (($event->title ?? 'Events') . ' - DevMantra')); ?>
...
<?php if($event->og_image ?? null): ?>
<?php $__env->startSection('og_image', $event->og_image); ?>
<?php elseif($event->featured_image ?? null): ?>
<?php $__env->startSection('og_image', $event->featured_image); ?>
<?php endif; ?>
<?php if($event->canonical_url ?? null): ?>
<?php $__env->startSection('canonical_url', $event->canonical_url); ?>
<?php endif; ?>
<?php if($event->noindex ?? false): ?>
...
?>
<script type="application/ld+json"><?php echo json_encode($eventSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?></script>
...
<?php if($event->custom_head ?? null): ?><?php echo $event->custom_head; ?><?php endif; ?>
<?php $__env->stopPush(); ?>
