...
const FIELD_SCHEMAS = {
  ...
  'about-knowledge-partner': {
    label: 'Knowledge Partner — CA India',
    icon: 'fa-solid fa-handshake',
    fields: [
      { key:'label',             type:'text',     label:'Eyebrow Label',       hint:'e.g. Our Knowledge Partner' },
      { key:'title',             type:'text',     label:'Heading',             hint:'e.g. Our Knowledge Partner' },
      { key:'title_highlight',   type:'text',     label:'Highlighted Word',    hint:'Word in heading to colour with brand accent, e.g. Partner' },
      { key:'description',       type:'textarea', label:'Description Paragraph' },
      { key:'logo_image',        type:'text',     label:'Logo Image Path',     hint:'e.g. assets/img/about-us/caindia.jpg' },
      { key:'certificate_image', type:'text',     label:'Certificate Image Path', hint:'e.g. assets/img/about-us/peercertificate.jpg' },
    ]
  },
  'about-values': {
...
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\service-sections\partials\_builder.blade.php ENDPATH**/ ?>