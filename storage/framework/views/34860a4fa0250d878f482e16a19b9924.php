...
<?php if (! $__env->hasRenderedOnce('54a0694a-4b47-4f47-af15-61484b4da603')): $__env->markAsRenderedOnce('54a0694a-4b47-4f47-af15-61484b4da603'); ?>
...
<section class="ss-process">
    <div class="container container-1230">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <?php if($title): ?>
                <h2 class="ss-process-title tp_fade_anim" data-delay=".2"><?php echo e($title); ?></h2>
                <?php endif; ?>
                <?php if($description): ?>
                <p class="ss-process-desc tp_fade_anim" data-delay=".3"><?php echo e($description); ?></p>
                <?php endif; ?>

                <div class="ss-process-steps-wrap" id="ss-process-steps-<?php echo e(md5(implode('', array_column($steps, 'title')))); ?>">
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ss-process-step">
                        <div class="ss-process-num"><?php echo e($step['number'] ?? ($loop->iteration)); ?></div>
                        <div class="ss-process-step-card">
                            <div class="ss-process-body">
                                <?php if(!empty($step['stage'])): ?>
                                <div class="ss-process-stage"><?php echo e($step['stage']); ?></div>
                                <?php endif; ?>
                                <?php if(!empty($step['title'])): ?>
                                <div class="ss-process-step-title"><?php echo e($step['title']); ?></div>
                                <?php endif; ?>
                                <div class="ss-process-step-desc"><?php echo e($step['description'] ?? ''); ?></div>
                                <?php if(!empty($step['value'])): ?>
                                <span class="ss-process-step-value"><?php echo e($step['value']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ss-process-metrics tp_fade_anim" data-delay=".5">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($row['metric'] ?? ''); ?></td>
                                <td><?php echo e($row['outcome'] ?? ''); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\components\service-sections\process-steps.blade.php ENDPATH**/ ?>