<?php $__env->startSection('title', $report->meta_title ?: $report->title); ?>
<?php $__env->startSection('meta_description', $report->meta_description ?? $report->excerpt ?? Str::limit(strip_tags($report->content), 160)); ?>
<?php $__env->startSection('og_type', 'article'); ?>
<?php $reportOg = $report->og_image ?: ($report->featured_image ? asset('storage/' . $report->featured_image) : null); ?>
<?php if($reportOg): ?>
<?php $__env->startSection('og_image', $reportOg); ?>
<?php endif; ?>
<?php if($report->canonical_url): ?>
<?php $__env->startSection('canonical_url', $report->canonical_url); ?>
<?php endif; ?>
<?php if($report->noindex): ?>
<?php $__env->startSection('noindex', '1'); ?>
<?php endif; ?>

<?php $__env->startPush('schema'); ?>
<?php echo \App\Services\SchemaService::reportSchema($report); ?>
...
<?php $__env->stopPush(); ?>
<?php if($report->custom_head): ?>
<?php $__env->startPush('custom_head'); ?>
<?php echo $report->custom_head; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-meta tp_fade_anim" data-delay=".3">
                    <span class="dm-article-meta-tag">Report</span>
                    <?php if($report->edition_label): ?>
                    <span class="dm-article-meta-item"><?php echo e($report->edition_label); ?></span>
                    <?php endif; ?>
                    <span class="dm-article-meta-item"><?php echo e($report->published_at?->format('M d, Y') ?? $report->created_at->format('M d, Y')); ?></span>
                    <span class="dm-article-meta-item dm-read-time-badge">
                        <i class="fa-regular fa-clock"></i>
                        <?php echo e($report->read_time ?: '5 min read'); ?>

                    </span>
                </div>
                <h1 class="dm-article-hero-title tp-text-revel-anim" data-delay=".5"><?php echo e($report->title); ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-featured-img tp_fade_anim" data-delay=".3">
                    <img src="<?php echo e(asset('storage/' . $report->featured_image)); ?>" alt="<?php echo e($report->title); ?>" loading="lazy">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container container-1230">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <?php if($report->button_url): ?>
                <div style="margin:40px 0 0;">
                    <a href="<?php echo e($report->button_url); ?>" target="_blank" rel="noopener noreferrer" style="
                    ...
                    " onmouseover="this.style.opacity='.75'" onmouseout="this.style.opacity='1'">
                        <?php echo e($report->button_text ?: 'Read More'); ?>
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        <a href="<?php echo e(route('report.index')); ?>">Report</a>
                        <?php if($report->edition_label): ?>
                        <a href="<?php echo e(route('report.index')); ?>"><?php echo e($report->edition_label); ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($report->title)); ?>" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <!--        <div class="dm-sidebar-label">Recent Reports</div>-->
            <!--        <?php $__currentLoopData = $sidebarReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidePost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
            <!--        <div class="dm-sidebar-post">-->
            <!--            <div class="dm-sidebar-post-thumb">-->
            <!--                <?php if($sidePost->featured_image): ?>-->
            <!--                    <a href="<?php echo e(route('report.show', $sidePost->slug)); ?>">-->
            ...
            <!--                    <?php echo e($sidePost->edition_label ?? 'Report'); ?>-->
            <!--                </span>-->
            <!--                <h5 class="dm-sidebar-post-title">-->
            <!--                    <a href="<?php echo e(route('report.show', $sidePost->slug)); ?>"><?php echo e($sidePost->title); ?></a>-->
            <!--                </h5>-->
...
<div class="dm-related-posts">
    <div class="container container-1230">
        <div class="dm-related-posts-title tp_fade_anim" data-delay=".3">More Reports</div>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-related-card tp_fade_anim" data-delay=".<?php echo e(3 + ($loop->index * 2)); ?>">
                    <div class="dm-related-card-thumb">
                        <a href="<?php echo e(route('report.show', $post->slug)); ?>">
                    ...
                    <span class="dm-related-card-category"><?php echo e($post->edition_label ?? 'Report'); ?></span>
                    <h4 class="dm-related-card-title">
                        <a href="<?php echo e(route('report.show', $post->slug)); ?>"><?php echo e($post->title); ?></a>
                    </h4>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\report-detail.blade.php ENDPATH**/ ?>