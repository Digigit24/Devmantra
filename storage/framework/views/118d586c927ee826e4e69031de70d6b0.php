<?php $__env->startSection('title', 'Trashed Newsletters'); ?>
...
<div class="dm-table-wrap">
    <div class="dm-table-header">
        <form method="GET" class="d-flex gap-2">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search trashed newsletters..." class="dm-form-input" style="max-width:260px;">
    ...
    <table class="dm-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:13px;color:var(--dm-text-muted);"><?php echo e($newsletter->deleted_at->format('M d, Y')); ?></td>
                <td>
                    <div class="d-flex gap-2">
                        <form method="POST" action="<?php echo e(route('admin.newsletters.restore', $newsletter->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="dm-btn dm-btn-primary dm-btn-sm">
                                <i class="fa-solid fa-rotate-left"></i> Restore
                            </button>
                        </form>
                        <form method="POST" action="<?php echo e(route('admin.newsletters.force-delete', $newsletter->id)); ?>" onsubmit="return confirm('Permanently delete this newsletter? This cannot be undone.')">
