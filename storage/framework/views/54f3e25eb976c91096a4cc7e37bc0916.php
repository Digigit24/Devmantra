...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sign In'); ?> - <?php echo e(config('app.name', 'DevMantra')); ?></title>
...
<body>
    ...
    <div class="auth-brand">
        <div class="auth-brand-logo">
            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/img/logo/logo.jpeg')); ?>" alt="DevMantra"></a>
        </div>
        ...
        <div class="auth-brand-footer">
            &copy; <?php echo e(date('Y')); ?> DevMantra. All rights reserved.
        </div>
...
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\layouts\guest.blade.php ENDPATH**/ ?>