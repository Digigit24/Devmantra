...
<?php if (! $__env->hasRenderedOnce('33d4662d-bcee-49b5-aa43-ce894e2f0c9f')): $__env->markAsRenderedOnce('33d4662d-bcee-49b5-aa43-ce894e2f0c9f'); ?>
    ...
    <div class="container container-1230" style="position:relative;z-index:1;">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5 dm-ap-header-col">
                <div class="dm-ap-eyebrow"><?php echo e($label); ?></div>
                <h2 class="dm-ap-title">Our <span>Approach</span></h2>
                <p class="dm-ap-subtitle"><?php echo e($subtitle); ?></p>
                <div class="dm-ap-badge">
                    <i class="fa-solid fa-circle-check"></i>
                    <?php echo e(count($approachItems)); ?> core delivery principles
                </div>
            </div>
            ...
            <div class="col-lg-7 dm-ap-items-col">
                <div class="dm-ap-grid">
                    <?php $__currentLoopData = $approachItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dm-ap-item">
                        <div class="dm-ap-item-icon">
                            <i class="<?php echo e($item['icon']); ?>"></i>
                        </div>
                        <span class="dm-ap-item-text"><?php echo e($item['text']); ?></span>
                    </div>
    ...
    <div class="container container-1230" style="position:relative;z-index:1;">
        ...
        <div class="dm-lc-nav-wrap">
            <div class="dm-lc-track" id="lcTrack">
                ...
                <button class="dm-lc-stab <?php echo e($i === 0 ? 'is-active' : ''); ?>" data-lc-tab="<?php echo e($i); ?>">
                    <span class="dm-lc-stab-num"><?php echo e($stage['number']); ?></span>
                    <i class="dm-lc-stab-icon <?php echo e($stage['icon']); ?>"></i>
                    <span class="dm-lc-stab-label"><?php echo e($stage['label']); ?></span>
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="dm-lc-panels" id="lcPanels">
            <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="dm-lc-panel <?php echo e($i === 0 ? 'is-active' : ''); ?>" data-lc-panel="<?php echo e($i); ?>">
                <div class="dm-lc-card">
                    <div class="dm-lc-card-inner">
                        <div class="dm-lc-card-left">
                            <div class="dm-lc-card-icon-wrap">
                                <i class="<?php echo e($stage['icon']); ?>"></i>
                            </div>
                            <div class="dm-lc-card-num"><?php echo e($stage['number']); ?> / 05</div>
                        </div>
                        <div class="dm-lc-card-right">
                            <div class="dm-lc-card-stage">Stage <?php echo e($stage['number']); ?></div>
                            <h3 class="dm-lc-card-title"><?php echo e($stage['label']); ?></h3>
                            <div class="dm-lc-badges">
                                <?php $__currentLoopData = $stage['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="dm-lc-badge"><?php echo e($item); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
...
<?php if (! $__env->hasRenderedOnce('6d87115c-a6e2-495f-ab54-a0a499da1553')): $__env->markAsRenderedOnce('6d87115c-a6e2-495f-ab54-a0a499da1553'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/components/service-sections/page-approach-lifecycle.blade.php ENDPATH**/ ?>