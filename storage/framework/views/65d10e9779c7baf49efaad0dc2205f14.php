<?php $__env->startSection('title', 'Create Alert'); ?>
...
<form method="POST" action="<?php echo e(route('admin.alerts.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <select name="tag" class="dm-form-select" required>
                        <option value="tax" <?php echo e(old('tag') === 'tax' ? 'selected' : ''); ?>>Tax</option>
                        <option value="deal" <?php echo e(old('tag') === 'deal' ? 'selected' : ''); ?>>Deal</option>
                    </select>
                </div>
                <div class="dm-form-group">
                ...
                <button type="submit" class="dm-btn dm-btn-primary w-100">
                    <i class="fa-solid fa-check"></i> Create Alert
                </button>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\alerts\create.blade.php ENDPATH**/ ?>