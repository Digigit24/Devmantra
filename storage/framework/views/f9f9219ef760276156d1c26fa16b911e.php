...
<form method="POST" action="<?php echo e(route('admin.services.update', $service)); ?>" enctype="multipart/form-data">
        ...
        <div class="col-lg-8">
            <div class="dm-table-wrap" style="padding:24px;">
                <div class="dm-form-group">
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $service->title)); ?>" class="dm-form-input" required>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Slug</label>
                    <input type="text" name="slug" value="<?php echo e(old('slug', $service->slug)); ?>" class="dm-form-input">
                    <div class="dm-form-hint">Permalink: <?php echo e(url('/services/' . $service->slug)); ?></div>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Short Description</label>
                    <textarea name="short_description" class="dm-form-textarea" style="min-height:80px;"><?php echo e(old('short_description', $service->short_description)); ?></textarea>
                    <div class="dm-form-hint">Shown on homepage slider card</div>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Content *</label>
                    <textarea name="content" class="summernote" required><?php echo e(old('content', $service->content)); ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                <div class="dm-form-group">
                    ...
                    <select name="status" class="dm-form-select">
                        ...
                        <option value="published" <?php echo e(old('status', $service->status) === 'published' ? 'selected' : ''); ?>>Published</option>
                    </select>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Icon (Font Awesome class)</label>
                    <input type="text" name="icon" value="<?php echo e(old('icon', $service->icon)); ?>" class="dm-form-input" placeholder="e.g. fa-solid fa-chart-line">
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Card Image</label>
                    <?php if($service->image): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/' . $service->image)); ?>" style="width:100%;border-radius:8px;max-height:160px;object-fit:cover;" alt="">
                        </div>
                    <?php endif; ?>
                ...
                <div class="dm-form-group">
                    ...
                    <?php if($service->hero_image): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/' . $service->hero_image)); ?>" style="width:100%;border-radius:8px;max-height:160px;object-fit:cover;" alt="">
                        </div>
                    <?php endif; ?>
                ...
                <div class="dm-form-group">
                    ...
                    <?php if($service->featured_image): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/' . $service->featured_image)); ?>" style="width:100%;border-radius:8px;max-height:160px;object-fit:cover;" alt="">
                        </div>
                    <?php endif; ?>
                ...
                <div class="dm-form-group">
                    ...
                    <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $service->sort_order)); ?>" class="dm-form-input">
                </div>
                <div class="dm-form-group">
                    <div class="dm-form-check">
                        <input type="checkbox" name="show_on_homepage" value="1" <?php echo e(old('show_on_homepage', $service->show_on_homepage) ? 'checked' : ''); ?>>
    ...
    <div class="mt-4">
        <?php echo $__env->make('admin.partials._seo-panel', ['model' => $service], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</form>
...
<div id="page-sections-panel" class="dm-table-wrap" style="padding:20px 24px;margin-top:24px;">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
        ...
        <div style="display:flex;align-items:center;gap:8px;">
            <a href="<?php echo e(route('admin.services.sections.index', $service)); ?>" target="_blank"
        ...
        <div id="sidebar-form-view" style="display:none;">
            ...
            <div id="sidebar-type-picker" style="display:none;">
                ...
                <div class="sdr-type-grid">
                    <?php $__currentLoopData = ServiceSection::sectionTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="sdr-type-card" data-type="<?php echo e($key); ?>" onclick="sidebarSelectType('<?php echo e($key); ?>')">
                        <span class="sdr-type-card-icon"><i class="fa-solid fa-layer-group"></i></span>
                        <span class="sdr-type-card-name"><?php echo e(explode(' — ', $meta['label'])[0]); ?></span>
                    </div>
...
const sectionsBase = '<?php echo e(rtrim(route("admin.services.sections.index", $service), "/")); ?>';

let sidebarMode       = 'library'; // 'library' | 'add' | 'edit'
let editingSectionId  = null;
let drawerCurrentType = null;
let sectionsList      = <?php echo json_encode($service->sections()->orderBy('sort_order')->get(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>