    ...
    <div id="seoPanelBody" style="display:none; padding:24px;">
            ...
            <div class="dm-form-hint" style="display:flex; justify-content:space-between;">
                ...
                <span>
                    <span id="seo_meta_title_count"
                          style="font-weight:700;"><?php echo e(mb_strlen(old('meta_title', $seo?->meta_title ?? ''))); ?></span>
                    / 60
                </span>
            </div>
        </div>
        ...
        <div class="dm-form-group">
            ...
            <textarea id="seo_meta_description"
                      ...
                      placeholder="A concise summary of this page for search engines…"><?php echo e(old('meta_description', $seo?->meta_description ?? '')); ?></textarea>
            <div class="dm-form-hint" style="display:flex; justify-content:space-between;">
                <span>Ideal: 120–160 characters</span>
                <span>
                    <span id="seo_meta_desc_count"
                          style="font-weight:700;"><?php echo e(mb_strlen(old('meta_description', $seo?->meta_description ?? ''))); ?></span>
                    / 160
                </span>
            </div>
        </div>
        ...
        <div class="dm-form-group">
            ...
            <?php $currentOg = old('og_image', $seo?->og_image ?? ''); ?>
            <?php if($currentOg): ?>
            <div style="margin-bottom:12px;">
                <img src="<?php echo e($currentOg); ?>" alt="Current OG image"
        ...
        <div class="dm-form-group">
            ...
            <input type="url"
                   ...
                   name="canonical_url"
                   class="dm-form-input"
                   value="<?php echo e(old('canonical_url', $seo?->canonical_url ?? '')); ?>"
        ...
        <div class="dm-form-group">
            <div class="dm-form-check" style="display:flex; align-items:center; gap:10px;">
                ...
                <input type="checkbox"
                       ...
                       name="noindex"
                       value="1"
                       <?php echo e(old('noindex', $seo?->noindex ?? false) ? 'checked' : ''); ?>
        ...
        <div class="dm-form-group" style="margin-bottom:0;">
            ...
            <textarea id="seo_custom_head"
                      ...
                      placeholder="<!-- e.g. extra meta tags, JSON-LD schema, etc. -->"><?php echo e(old('custom_head', $seo?->custom_head ?? '')); ?></textarea>
...
<?php if (! $__env->hasRenderedOnce('59e5742e-8948-45d0-97a7-76a57a6edccd')): $__env->markAsRenderedOnce('59e5742e-8948-45d0-97a7-76a57a6edccd'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\partials\_seo-panel.blade.php ENDPATH**/ ?>