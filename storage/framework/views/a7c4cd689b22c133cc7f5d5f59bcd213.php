...
<a href="<?php echo e(route('admin.case-studies.trash')); ?>" class="dm-btn dm-btn-outline dm-btn-sm">
    <i class="fa-solid fa-trash-can"></i> Trash (<?php echo e($trashedCount); ?>)
</a>
<?php endif; ?>
<a href="<?php echo e(route('admin.case-studies.create')); ?>" class="dm-btn dm-btn-primary">
...
<div class="dm-table-wrap">
    <div class="dm-table-header">
        <form method="GET" class="d-flex gap-2">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search case studies..." class="dm-form-input" style="max-width:260px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('admin.case-studies.edit', $item)); ?>" class="dm-btn dm-btn-outline dm-btn-sm">
                            <i class="fa-solid fa-pen"></i>
                        </a>
                        <form method="POST" action="<?php echo e(route('admin.case-studies.destroy', $item)); ?>" onsubmit="return confirm('Delete this case study?')">
            ...
            <tr>
                <td colspan="7" style="text-align:center;padding:40px;color:var(--dm-text-muted);">
                    ...
                    No case studies yet. <a href="<?php echo e(route('admin.case-studies.create')); ?>">Create your first case study</a>
                </td>
            </tr>
            <?php endif; ?>
        </tbody>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\case-studies\index.blade.php ENDPATH**/ ?>