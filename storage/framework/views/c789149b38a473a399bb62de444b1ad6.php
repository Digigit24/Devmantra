...
?>
<?php if($serviceOg): ?>
<?php $__env->startSection('og_image', $serviceOg); ?>
<?php endif; ?>
<?php if($service->canonical_url): ?>
<?php $__env->startSection('canonical_url', $service->canonical_url); ?>
<?php endif; ?>
<?php if($service->noindex): ?>
<?php $__env->startSection('noindex', '1'); ?>
<?php endif; ?>


<?php if($service->custom_head): ?>
<?php $__env->startPush('custom_head'); ?>
<?php echo $service->custom_head; ?>

<?php $__env->stopPush(); ?>
<?php else: ?>
<?php $__env->startPush('schema'); ?>
<?php echo \App\Services\SchemaService::serviceSchema($service); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-featured-img tp_fade_anim" data-delay=".3">
                    <img src="<?php echo e(asset('storage/' . ($service->featured_image ?? $service->hero_image ?? $service->image))); ?>" alt="<?php echo e($service->title); ?>" loading="lazy">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="dm-sidebar-post-thumb">
                            <?php if($sideService->image): ?>
                                <a href="<?php echo e(route('service.show', $sideService->slug)); ?>">
                                    <img src="<?php echo e(asset('storage/' . $sideService->image)); ?>" alt="<?php echo e($sideService->title); ?>" loading="lazy">
                                </a>
                            <?php elseif($sideService->hero_image): ?>
                                <a href="<?php echo e(route('service.show', $sideService->slug)); ?>">
                                    <img src="<?php echo e(asset('storage/' . $sideService->hero_image)); ?>" alt="<?php echo e($sideService->title); ?>" loading="lazy">
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('service.show', $sideService->slug)); ?>">
                    ...
                    <div class="dm-related-card-thumb">
                        <a href="<?php echo e(route('service.show', $relService->slug)); ?>">
                            <?php if($relService->image): ?>
                                <img src="<?php echo e(asset('storage/' . $relService->image)); ?>" alt="<?php echo e($relService->title); ?>" loading="lazy">
                            <?php elseif($relService->hero_image): ?>
                                <img src="<?php echo e(asset('storage/' . $relService->hero_image)); ?>" alt="<?php echo e($relService->title); ?>" loading="lazy">
                            <?php else: ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\service-detail.blade.php ENDPATH**/ ?>