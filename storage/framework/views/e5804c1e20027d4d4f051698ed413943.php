<?php $__env->startSection('title', $alert->meta_title ?: ($alert->title . ' - DevMantra')); ?>
<?php $__env->startSection('meta_description', $alert->meta_description ?: ($alert->excerpt ?? Str::limit(strip_tags($alert->content), 160))); ?>
<?php $__env->startSection('og_type', 'article'); ?>
<?php if($alert->og_image): ?>
<?php $__env->startSection('og_image', $alert->og_image); ?>
<?php elseif($alert->featured_image): ?>
<?php $__env->startSection('og_image', asset('storage/' . $alert->featured_image)); ?>
<?php endif; ?>
<?php if($alert->canonical_url): ?>
<?php $__env->startSection('canonical_url', $alert->canonical_url); ?>
<?php endif; ?>
<?php if($alert->noindex): ?>
...
?>
<script type="application/ld+json"><?php echo json_encode($alertSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?></script>
...
<?php if($alert->custom_head): ?><?php echo $alert->custom_head; ?><?php endif; ?>
<?php $__env->stopPush(); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-meta tp_fade_anim" data-delay=".3">
                    <span class="dm-article-meta-tag"><?php echo e(ucfirst($alert->tag)); ?> Alert</span>
                    <span class="dm-article-meta-item"><?php echo e($alert->published_at?->format('M d, Y') ?? $alert->created_at->format('M d, Y')); ?></span>
                    <span class="dm-article-meta-item dm-read-time-badge">
                        <i class="fa-regular fa-clock"></i>
                        <?php echo e($alert->read_time ?: '5 min read'); ?>

                    </span>
                </div>
                <h1 class="dm-article-hero-title tp-text-revel-anim" data-delay=".5"><?php echo e($alert->title); ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-featured-img tp_fade_anim" data-delay=".3">
                    <img src="<?php echo e(asset('storage/' . $alert->featured_image)); ?>" alt="<?php echo e($alert->title); ?>" loading="lazy">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        <a href="<?php echo e(route('alert.index', ['tag' => $alert->tag])); ?>"><?php echo e(ucfirst($alert->tag)); ?> Alert</a>
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($alert->title)); ?>" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <div class="col-lg-4">
                <div class="dm-sidebar">
                    <div class="dm-sidebar-label">Recent Alerts</div>
                    ...
                    <div class="dm-sidebar-post">
                        <div class="dm-sidebar-post-thumb">
                            <a href="<?php echo e(route('alert.show', $sidePost->slug)); ?>">
                                <?php if($sidePost->featured_image): ?>
                                    <img src="<?php echo e(asset( $sidePost->featured_image)); ?>" alt="<?php echo e($sidePost->title); ?>" loading="lazy">
                                <?php else: ?>
                        ...
                        <div class="dm-sidebar-post-info">
                            <span class="dm-sidebar-post-category"><?php echo e(ucfirst($sidePost->tag)); ?> Alert</span>
                            <h5 class="dm-sidebar-post-title">
                                <a href="<?php echo e(route('alert.show', $sidePost->slug)); ?>"><?php echo e($sidePost->title); ?></a>
                            </h5>
...
<div class="dm-related-posts">
    <div class="container container-1230">
        <div class="dm-related-posts-title tp_fade_anim" data-delay=".3">Related Alerts</div>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-related-card tp_fade_anim" data-delay=".<?php echo e(3 + ($loop->index * 2)); ?>">
                    <div class="dm-related-card-thumb">
                        <a href="<?php echo e(route('alert.show', $post->slug)); ?>">
                    ...
                    <span class="dm-related-card-category"><?php echo e(ucfirst($post->tag)); ?> Alert</span>
                    <h4 class="dm-related-card-title">
                        <a href="<?php echo e(route('alert.show', $post->slug)); ?>"><?php echo e($post->title); ?></a>
                    </h4>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\alert-detail.blade.php ENDPATH**/ ?>