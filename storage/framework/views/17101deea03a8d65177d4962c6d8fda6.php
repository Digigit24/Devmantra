...
<?php if (! $__env->hasRenderedOnce('35d1e8c2-d4ad-4ddc-a28a-ed115d6be199')): $__env->markAsRenderedOnce('35d1e8c2-d4ad-4ddc-a28a-ed115d6be199'); ?>
...
<section class="ss-cfo">
    <div class="container container-1230" style="position:relative;z-index:1;">
        ...
        <div class="ss-cfo-header tp_fade_anim" data-delay=".2">
            <?php if($title): ?>
            <h2 class="ss-cfo-title"><?php echo e($title); ?></h2>
            <?php endif; ?>
            <?php if($description): ?>
            <p class="ss-cfo-desc"><?php echo e($description); ?></p>
            <?php endif; ?>
        </div>
            ...
            <div class="col-lg-6 tp_fade_anim" data-delay=".3">
                <div class="ss-cfo-left">
                    ...
                    <h3 class="ss-cfo-col-title">
                        ...
                        <?php echo e($scopeTitle); ?>

                    </h3>
                    <?php endif; ?>
                    <ul class="ss-cfo-checklist">
                        <?php $__currentLoopData = $scopeItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                ...
                <div class="ss-cfo-right">
                    ...
                    <div class="ss-cfo-type-grid">
                        ...
                        <div class="ss-cfo-type-card">
                            ...
                            <p class="ss-cfo-type-name"><?php echo e($type); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\components\service-sections\cfo-services.blade.php ENDPATH**/ ?>