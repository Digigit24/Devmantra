...
<?php if (! $__env->hasRenderedOnce('840da2ea-de52-49e6-91d7-3dab38205649')): $__env->markAsRenderedOnce('840da2ea-de52-49e6-91d7-3dab38205649'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="tp_fade_anim" data-delay=".2">
                    <?php if($eyebrow): ?><span class="ss-cpa-eyebrow"><?php echo e($eyebrow); ?></span><?php endif; ?>
                    <h2 class="ss-cpa-title"><?php echo e($title); ?></h2>
                    <?php if($opening): ?><p class="ss-cpa-opening"><?php echo e($opening); ?></p><?php endif; ?>

                    <?php if(!empty($pressurePoints)): ?>
                    <div class="ss-cpa-pressures">
                        <?php $__currentLoopData = $pressurePoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($description): ?><p class="ss-cpa-desc"><?php echo e($description); ?></p><?php endif; ?>

                    <div class="ss-cpa-cards">
                        <?php if($oldModelDesc): ?>
                        <div class="ss-cpa-old-card">
                            <div class="ss-cpa-old-label"><?php echo e($oldModelTitle); ?></div>
                            <p class="ss-cpa-old-text"><?php echo e($oldModelDesc); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if($shiftDesc): ?>
                        <div class="ss-cpa-shift-card">
                            <div class="ss-cpa-shift-label"><?php echo e($shiftTitle); ?></div>
                            <p class="ss-cpa-shift-text"><?php echo e($shiftDesc); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views/components/service-sections/cpa-reality.blade.php ENDPATH**/ ?>