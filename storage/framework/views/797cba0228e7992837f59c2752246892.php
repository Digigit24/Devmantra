<?php $__env->startSection('title', 'Popup Banner'); ?>
...
<form method="POST" action="<?php echo e(route('admin.popup.update')); ?>">
            ...
            <div style="display:flex; flex-direction:column; gap:12px;">
                ...
                <div class="dm-toggle-group">
                    ...
                    <label class="dm-switch">
                        <input type="checkbox" name="popup_enabled" value="1" <?php echo e(\App\Models\SiteSetting::get('popup_enabled','0') === '1' ? 'checked' : ''); ?>>
                ...
                <div class="dm-toggle-group">
                    ...
                    <label class="dm-switch">
                        <input type="checkbox" name="popup_show_exit_intent" value="1" <?php echo e(\App\Models\SiteSetting::get('popup_show_exit_intent','1') === '1' ? 'checked' : ''); ?>>
                        <span class="dm-switch-slider"></span>
                    </label>
                </div>
                ...
                <div class="dm-toggle-group">
                    ...
                    <label class="dm-switch">
                        <input type="checkbox" name="popup_show_scroll" value="1" <?php echo e(\App\Models\SiteSetting::get('popup_show_scroll','1') === '1' ? 'checked' : ''); ?>>
                        <span class="dm-switch-slider"></span>
                    </label>
                </div>
                ...
                <div class="dm-toggle-group">
                    ...
                    <label class="dm-switch">
                        <input type="checkbox" name="popup_timer_enabled" value="1" <?php echo e(\App\Models\SiteSetting::get('popup_timer_enabled','0') === '1' ? 'checked' : ''); ?>>
                        <span class="dm-switch-slider"></span>
                    </label>
                </div>
                        ...
                        <div class="dm-form-group mb-0">
                            ...
                            <div class="dm-input-suffix-wrap">
                                <input type="number" name="popup_trigger_scroll" min="10" max="95"
                                    value="<?php echo e(\App\Models\SiteSetting::get('popup_trigger_scroll','55')); ?>"
                                    class="dm-form-input">
                        ...
                        <div class="dm-form-group mb-0">
                            ...
                            <div class="dm-input-suffix-wrap">
                                <input type="number" name="popup_timer_delay" min="1" max="120"
                                    value="<?php echo e(\App\Models\SiteSetting::get('popup_timer_delay','8')); ?>"
                                    class="dm-form-input">
        ...
        <div class="dm-section-card">
            ...
            <div class="dm-form-group">
                ...
                <input type="text" name="popup_headline" class="dm-form-input"
                    ...
                    value="<?php echo e(\App\Models\SiteSetting::get('popup_headline')); ?>">
            </div>

            <div class="dm-form-group">
                <label class="dm-form-label">Subtext / Intro</label>
                <textarea name="popup_subtext" class="dm-form-textarea" style="min-height:80px;"
                    placeholder="Talk to Dev Mantra's cross-border advisory team about:"><?php echo e(\App\Models\SiteSetting::get('popup_subtext')); ?></textarea>
            </div>

            <div class="dm-form-group">
                <label class="dm-form-label">Numbered Points</label>
                <textarea name="popup_points" class="dm-form-textarea" style="min-height:110px;"
                    placeholder="One point per line…"><?php echo e(\App\Models\SiteSetting::get('popup_points')); ?></textarea>
            ...
            <div class="dm-form-group mb-0">
                ...
                <input type="text" name="popup_supporting_text" class="dm-form-input"
                    ...
                    value="<?php echo e(\App\Models\SiteSetting::get('popup_supporting_text')); ?>">
                ...
                <div class="col-md-6">
                    <div class="dm-form-group">
                        ...
                        <input type="text" name="popup_primary_cta_text" class="dm-form-input"
                            ...
                            value="<?php echo e(\App\Models\SiteSetting::get('popup_primary_cta_text')); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="dm-form-group">
                        ...
                        <input type="text" name="popup_primary_cta_url" class="dm-form-input"
                            placeholder="/contact"
                            value="<?php echo e(\App\Models\SiteSetting::get('popup_primary_cta_url')); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="dm-form-group mb-0">
                        ...
                        <input type="text" name="popup_secondary_cta_text" class="dm-form-input"
                            ...
                            value="<?php echo e(\App\Models\SiteSetting::get('popup_secondary_cta_text')); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="dm-form-group mb-0">
                        ...
                        <input type="text" name="popup_secondary_cta_url" class="dm-form-input"
                            ...
                            value="<?php echo e(\App\Models\SiteSetting::get('popup_secondary_cta_url')); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dm-section-card" style="padding:0;overflow:hidden;">
            ...
            <div style="padding:16px;">
                <div class="dm-popup-preview-card">
                    ...
                    <div class="dm-popup-preview-inner">
                        ...
                        <div class="dm-popup-preview-headline">
                            <?php echo e(\App\Models\SiteSetting::get('popup_headline', 'Expanding to or in India? Avoid costly compliance mistakes.')); ?>

                        </div>
                        <div class="dm-popup-preview-sub">
                            <?php echo e(\App\Models\SiteSetting::get('popup_subtext', 'Talk to Dev Mantra\'s cross-border advisory team about:')); ?>

                        </div>
                        <?php
                            $pts = array_filter(array_map('trim', explode("\n", \App\Models\SiteSetting::get('popup_points', ''))));
                        ?>
                        <?php $__currentLoopData = array_values($pts); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="dm-popup-preview-point">
                            <span class="dm-popup-preview-point-num"><?php echo e(str_pad($i+1,2,'0',STR_PAD_LEFT)); ?></span>
                            <span class="dm-popup-preview-point-text"><?php echo e($pt); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="dm-popup-preview-btns">
                            <div class="dm-popup-preview-btn-primary">
                                <?php echo e(\App\Models\SiteSetting::get('popup_primary_cta_text', 'Book a Free 20-Minute Strategy Call')); ?>

                            </div>
                            <?php if(\App\Models\SiteSetting::get('popup_secondary_cta_text')): ?>
                            <div class="dm-popup-preview-btn-secondary">
                                <?php echo e(\App\Models\SiteSetting::get('popup_secondary_cta_text')); ?>

                            </div>
                            <?php endif; ?>
                        </div>
                        <?php if(\App\Models\SiteSetting::get('popup_supporting_text')): ?>
                        <div class="dm-popup-preview-support">
                            <?php echo e(\App\Models\SiteSetting::get('popup_supporting_text')); ?>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;margin-top:14px;padding:10px 14px;background:var(--dm-dark);border-radius:10px;">
                    ...
                    <?php if(\App\Models\SiteSetting::get('popup_enabled','0') === '1'): ?>
                ...
                <div style="display:flex;gap:6px;margin-top:8px;">
                    <?php if(\App\Models\SiteSetting::get('popup_show_exit_intent','1') === '1'): ?>
                    ...
                    <?php endif; ?>
                    <?php if(\App\Models\SiteSetting::get('popup_show_scroll','1') === '1'): ?>
                    <span style="font-size:11px;font-weight:600;color:var(--dm-purple);background:var(--dm-purple-light);padding:4px 10px;border-radius:20px;">Scroll <?php echo e(\App\Models\SiteSetting::get('popup_trigger_scroll','55')); ?>% ✓</span>
                    <?php endif; ?>
                    <?php if(\App\Models\SiteSetting::get('popup_timer_enabled','0') === '1'): ?>
                    <span style="font-size:11px;font-weight:600;color:var(--dm-purple);background:var(--dm-purple-light);padding:4px 10px;border-radius:20px;">Timer <?php echo e(\App\Models\SiteSetting::get('popup_timer_delay','8')); ?>s ✓</span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\popup\edit.blade.php ENDPATH**/ ?>