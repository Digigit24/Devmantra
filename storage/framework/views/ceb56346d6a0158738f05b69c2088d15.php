    ...
    <section class="hero" data-od-id="results-hero">
      <div class="shell"><div class="hero__frame">
        ...
        <div class="hero__image" data-reveal>
          <img src="<?php echo e(asset('assets/vision-card/img/vision-founder-hero.png')); ?>" alt="Business founder reviewing a strategic growth blueprint">
  ...
  <div class="modal" id="vcrShareModal" role="dialog" aria-modal="true" aria-labelledby="vcrShareTitle">
    <div class="modal__panel">
      ...
      <div class="social-card">
        <img src="<?php echo e(asset('assets/vision-card/img/vision-founder-hero.png')); ?>" alt="Blueprint cover preview">
...
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/frontend/vision-card/partials/results.blade.php ENDPATH**/ ?>