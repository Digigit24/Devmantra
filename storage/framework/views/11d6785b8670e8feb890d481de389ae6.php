...
<?php if($popupEnabled && ($headline || $primaryCtaText)): ?>
...
<div class="dm-popup-overlay" id="dmPopupOverlay" role="dialog" aria-modal="true" aria-label="Advisory popup">
    <div class="dm-popup-card">
        ...
        <div class="dm-popup-inner">
            ...
            <?php if($headline): ?>
            <h2 class="dm-popup-headline"><?php echo e($headline); ?></h2>
            <?php endif; ?>

            
            <?php if($subtext): ?>
            <p class="dm-popup-subtext"><?php echo e($subtext); ?></p>
            <?php endif; ?>
            ...
            <div class="dm-popup-points">
                ...
                <div class="dm-popup-point">
                    <span class="dm-popup-point-num"><?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></span>
                    <span class="dm-popup-point-text"><?php echo e($point); ?></span>
                </div>
            ...
            <div class="dm-popup-actions">
                <?php if($primaryCtaText): ?>
                <a href="<?php echo e($primaryCtaUrl); ?>" class="dm-popup-btn-primary" id="dmPopupPrimary">
                ...
                <a href="<?php echo e($secondaryCtaUrl); ?>" class="dm-popup-btn-secondary" id="dmPopupSecondary">
            ...
            <p class="dm-popup-support"><?php echo e($supportingText); ?></p>
            <?php endif; ?>
...
(function () {
    ...
    var exitIntentEnabled = <?php echo e($showExitIntent ? 'true' : 'false'); ?>;
    var scrollEnabled     = <?php echo e($showScroll ? 'true' : 'false'); ?>;
    var scrollDepth       = <?php echo e($scrollDepth); ?>;
    var timerEnabled      = <?php echo e($timerEnabled ? 'true' : 'false'); ?>;
    var timerDelay        = <?php echo e($timerDelay * 1000); ?>; // convert seconds → ms
...
<?php endif; ?> 
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/frontend/partials/popup.blade.php ENDPATH**/ ?>