...
<?php $__env->startSection('meta_description', $blog->meta_description ?? Str::limit($blog->clean_excerpt, 160)); ?>
<?php $__env->startSection('og_type', 'article'); ?>
<?php $blogOg = $blog->og_image ?: ($blog->featured_image ? asset('storage/' . $blog->featured_image) : null); ?>
<?php if($blogOg): ?>
<?php $__env->startSection('og_image', $blogOg); ?>
<?php endif; ?>
<?php if($blog->canonical_url): ?>
<?php $__env->startSection('canonical_url', $blog->canonical_url); ?>
<?php endif; ?>
<?php if($blog->noindex): ?>
...
<?php if($blog->custom_head): ?>
<?php $__env->startPush('custom_head'); ?>
<?php echo $blog->custom_head; ?>

<?php $__env->stopPush(); ?>
<?php else: ?>
<?php $__env->startPush('schema'); ?>
<?php echo \App\Services\SchemaService::blogSchema($blog); ?>
...
<?php $__env->stopPush(); ?>
<link rel="stylesheet" href="<?php echo e(asset('assets/css/dm-blog-components.css')); ?>">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="dm-article-meta tp_fade_anim" data-delay=".3">
                    <span class="dm-article-meta-tag"><?php echo e($blog->category); ?></span>
                    <span class="dm-article-meta-item"><?php echo e($blog->published_at?->format('M d, Y') ?? $blog->created_at->format('M d, Y')); ?></span>
                    <span class="dm-article-meta-item dm-read-time-badge">
                        <i class="fa-regular fa-clock"></i>
                        <?php echo e($blog->read_time ?: '5 min read'); ?>

                    </span>
                </div>
                <h1 class="dm-article-hero-title tp-text-revel-anim" data-delay=".5"><?php echo e($blog->title); ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        <a href="<?php echo e(route('blog.index')); ?>"><?php echo e($blog->category); ?></a>
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($blog->title)); ?>" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <div class="col-lg-4">
                <div class="dm-sidebar">
                    ...
                    <?php $__currentLoopData = $sidebarBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidePost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dm-sidebar-post">
                        <div class="dm-sidebar-post-thumb">
                            <?php if($sidePost->featured_image): ?>
                                <a href="<?php echo e(route('blog.show', $sidePost->slug)); ?>">
                        ...
                        <div class="dm-sidebar-post-info">
                            ...
                            <h5 class="dm-sidebar-post-title">
                                <a href="<?php echo e(route('blog.show', $sidePost->slug)); ?>"><?php echo e($sidePost->title); ?></a>
                            </h5>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\blog-detail.blade.php ENDPATH**/ ?>