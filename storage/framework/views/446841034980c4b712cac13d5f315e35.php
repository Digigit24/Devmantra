<?php $__env->startSection('title', 'Reports - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Access in-depth reports on industry trends, regulatory analysis, financial insights, and strategic business advisory.'); ?>
...
<div class="dm-past-editions">
    <div class="container container-1230">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="dm-report-featured-thumb tp_fade_anim" data-delay=".3">
                        <a href="<?php echo e(route('report.show', $featured->slug)); ?>">
                ...
                <div class="col-lg-6">
                    <div class="dm-report-featured-content tp_fade_anim" data-delay=".5">
                        ...
                        <h3 class="dm-report-featured-title">
                            <a href="<?php echo e(route('report.show', $featured->slug)); ?>"><?php echo e($featured->title); ?></a>
                        </h3>
                        ...
                        <div>
                            <a href="<?php echo e(route('report.show', $featured->slug)); ?>" class="dm-edition-card-link">
                                Read Report
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-edition-card tp_fade_anim" data-delay=".<?php echo e(3 + ($loop->index % 3)); ?>">
                    <div class="dm-edition-card-thumb">
                        <a href="<?php echo e(route('report.show', $report->slug)); ?>">
                            <?php if($report->featured_image): ?>
                                <img src="<?php echo e(asset('storage/' . $report->featured_image)); ?>" alt="<?php echo e($report->title); ?>">
                            <?php else: ?>
                                <img src="<?php echo e(asset('assets/img/home-13/blog/blog-thumb-' . (($loop->index % 3) + 1) . '.jpg')); ?>" alt="<?php echo e($report->title); ?>">
                            <?php endif; ?>
                        </a>
                    </div>
                    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin:16px 0 8px;">
                        <span class="dm-edition-card-date" style="margin:0;">
                            ...
                            <?php echo e($report->edition_label ?? $report->published_at?->format('F Y') ?? $report->created_at->format('F Y')); ?>
                    ...
                    <h4 class="dm-edition-card-title">
                        <a href="<?php echo e(route('report.show', $report->slug)); ?>"><?php echo e($report->title); ?></a>
                    </h4>
                    <p class="dm-edition-card-excerpt"><?php echo e($report->excerpt ?? Str::limit(strip_tags($report->content), 140)); ?></p>
                    <a href="<?php echo e(route('report.show', $report->slug)); ?>" class="dm-edition-card-link">
        ...
        <?php if($reports->hasPages()): ?>
            <?php echo e($reports->links('vendor.pagination.devmantra')); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\report-index.blade.php ENDPATH**/ ?>