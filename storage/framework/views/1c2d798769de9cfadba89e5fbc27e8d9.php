      ...
      <table width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;width:100%;">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#1b3c6b,#4a73c4);border-radius:16px 16px 0 0;padding:36px 40px;text-align:center;">
            <img src="<?php echo e(asset('favicon.png')); ?>" alt="Dev Mantra" width="56" height="56" style="border-radius:50%;display:block;margin:0 auto 16px;border:3px solid rgba(255,255,255,0.25);">
            ...
            <p style="margin:12px 0 0;font-size:15px;color:rgba(255,255,255,0.85);"><?php echo e($companyLabel); ?></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#ffffff;padding:40px;">
            ...
            <p style="margin:0 0 20px;font-size:16px;color:#1a1a2e;font-weight:500;">Hi <?php echo e($lead->name); ?>,</p>

            <p style="margin:0 0 24px;font-size:15px;color:#555;line-height:1.7;">
                Thank you for using the ESOP Allocation Calculator<?php echo e($lead->company ? ' for '.$lead->company : ''); ?>.
                Below is the recommended equity allocation for the <?php echo e(count($employees)); ?> employee<?php echo e(count($employees) === 1 ? '' : 's'); ?> you scored, calculated using the same pool-splitting logic as Dev Mantra's ESOP Allocation Model — a defensible, board-ready figure for each person, not a guess.
            </p>

            <?php if(!empty($reportUrl)): ?>
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
              <tr>
                <td align="center" style="padding:22px 20px;background:linear-gradient(135deg,#0a1c3a,#1b3c6b);border-radius:12px;">
                  ...
                  <a href="<?php echo e($reportUrl); ?>" style="display:inline-block;padding:13px 28px;background:linear-gradient(135deg,#d9a441,#b9832f);color:#241a04;text-decoration:none;border-radius:8px;font-size:14px;font-weight:700;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="50%" style="padding:0 8px 12px 0;">
                        ...
                        <p style="margin:2px 0 0;font-size:19px;font-weight:700;color:#1a1a2e;"><?php echo e(number_format($pool['esop_pool_percent'], 2)); ?>%</p>
                      </td>
                      <td width="50%" style="padding:0 0 12px 8px;">
                        ...
                        <p style="margin:2px 0 0;font-size:19px;font-weight:700;color:#1a1a2e;"><?php echo e(number_format($pool['hiring_reserve_percent'], 2)); ?>%</p>
                      </td>
                    </tr>
                    <tr>
                      <td width="50%" style="padding:0 8px 0 0;">
                        <p style="margin:0;font-size:11px;color:#8a9bb0;text-transform:uppercase;letter-spacing:0.5px;">Allocatable Pool</p>
                        <p style="margin:2px 0 0;font-size:19px;font-weight:700;color:#1a1a2e;"><?php echo e(number_format($pool['allocatable_pool_percent'], 2)); ?>%</p>
                      </td>
                      <td width="50%" style="padding:0 0 0 8px;">
                        <p style="margin:0;font-size:11px;color:#8a9bb0;text-transform:uppercase;letter-spacing:0.5px;">Total Recommended</p>
                        <p style="margin:2px 0 0;font-size:19px;font-weight:700;color:#1e9e5a;"><?php echo e(number_format($pool['total_allocated_percent'], 4)); ?>%</p>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:28px;">
              ...
              <?php $__currentLoopData = $rankedEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php ($r = $calc[$e->id] ?? []); ?>
              <tr>
                <td style="padding:12px;border-bottom:1px solid #f1f5f9;vertical-align:top;">
                  <span style="display:inline-block;width:24px;height:24px;line-height:24px;text-align:center;background:linear-gradient(135deg,#1b3c6b,#4a73c4);color:#fff;border-radius:50%;font-size:12px;font-weight:600;"><?php echo e($e->rank ?: '—'); ?></span>
                </td>
                <td style="padding:12px;border-bottom:1px solid #f1f5f9;vertical-align:top;">
                  <p style="margin:0;font-size:14px;font-weight:600;color:#1a1a2e;"><?php echo e($e->emp_name ?: '—'); ?></p>
                  <p style="margin:2px 0 0;font-size:12px;color:#8a9bb0;"><?php echo e($e->emp_designation ?: '—'); ?> &middot; <?php echo e($e->emp_seniority); ?></p>
                </td>
                <td style="padding:12px;border-bottom:1px solid #f1f5f9;font-size:13px;color:#444;vertical-align:top;"><?php echo e($e->total_score); ?>/100</td>
                <td style="padding:12px;border-bottom:1px solid #f1f5f9;font-size:15px;font-weight:700;color:#1e9e5a;vertical-align:top;" align="right"><?php echo e(number_format($r['final_grant_percent'] ?? 0, 4)); ?>%</td>
              </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
              <tr>
                <td style="padding:18px 22px;background:#f8fafc;border:1px solid #e8ecf0;border-radius:10px;">
                  ...
                  <p style="margin:0;font-size:14px;color:#333;line-height:1.7;"><?php echo e($overall['summary']); ?></p>
                </td>
              </tr>
            </table>
            <?php endif; ?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
              <tr>
                <td style="padding:16px 20px;background:<?php echo e(($pool['tier_pool_is_over_committed'] ?? false) ? '#fdf3f2' : '#effaf3'); ?>;border:1px solid <?php echo e(($pool['tier_pool_is_over_committed'] ?? false) ? '#f5dcd9' : '#d6f0e0'); ?>;border-radius:10px;">
                  <p style="margin:0 0 6px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:1px;color:<?php echo e(($pool['tier_pool_is_over_committed'] ?? false) ? '#d15a4a' : '#1e9e5a'); ?>;">Risk Flag</p>
                  <p style="margin:0;font-size:14px;color:<?php echo e(($pool['tier_pool_is_over_committed'] ?? false) ? '#5a332e' : '#2b4a38'); ?>;line-height:1.65;"><?php echo e($overall['risk_flag']); ?></p>
                </td>
              </tr>
            </table>
            <?php endif; ?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
              <tr>
                <td style="padding:16px 20px;background:#eef3fb;border:1px solid #dce6f5;border-radius:10px;">
                  ...
                  <p style="margin:0;font-size:14px;color:#243044;line-height:1.65;"><?php echo e($overall['vesting_suggestion']); ?></p>
                </td>
              </tr>
            </table>
            <?php endif; ?>
            ...
            <div style="margin-bottom:28px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <?php $__currentLoopData = $overall['next_steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td width="34" valign="top" style="padding:6px 0;">
                    <span style="display:inline-block;width:24px;height:24px;line-height:24px;text-align:center;background:linear-gradient(135deg,#1b3c6b,#4a73c4);color:#fff;border-radius:50%;font-size:12px;font-weight:600;"><?php echo e($i + 1); ?></span>
                  </td>
                  <td valign="top" style="padding:6px 0;font-size:14px;color:#333;line-height:1.6;"><?php echo e($step); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </table>
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:12px;">
              <tr>
                <td style="padding:14px 18px;background:#fbf8ef;border-left:4px solid #d9a441;border-radius:0 10px 10px 0;">
                  <p style="margin:0 0 4px;font-size:13px;font-weight:700;color:#1b3c6b;"><?php echo e($e->emp_name ?: 'Employee'); ?></p>
                  <?php if(!empty($note['rationale'])): ?>
                  <p style="margin:0 0 6px;font-size:13px;color:#4a3f28;line-height:1.6;"><?php echo e($note['rationale']); ?></p>
                  <?php endif; ?>
                  <?php if(!empty($note['retention_note'])): ?>
                  <p style="margin:0;font-size:12.5px;color:#6b5a35;line-height:1.6;font-style:italic;"><?php echo e($note['retention_note']); ?></p>
                  <?php endif; ?>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:8px;">
              <tr>
                <td align="center">
                  <a href="<?php echo e(route('esop-calculator.app')); ?>" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#1b3c6b,#4a73c4);color:#ffffff;text-decoration:none;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.2px;">
...
<?php /**PATH C:\Users\hrith\ritik\Devmantranew\resources\views/emails/esop-result.blade.php ENDPATH**/ ?>