...
<form method="POST" action="<?php echo e(route('admin.blogs.store')); ?>" enctype="multipart/form-data">
        ...
        <div class="col-lg-8">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <textarea name="content" id="contentInput" style="display:none"><?php echo e(old('content')); ?></textarea>
                    <div id="blogEditorWrap">
                        <?php echo $__env->make('admin.blogs.partials.snippet-library', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="category" value="<?php echo e(old('category', 'Blog')); ?>" class="dm-form-input">
                </div>
                <div class="dm-form-group">
    ...
    <div class="mt-4">
        <?php echo $__env->make('admin.partials._seo-panel', ['model' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</form>
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('assets/js/blog-html-editor.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\blogs\create.blade.php ENDPATH**/ ?>