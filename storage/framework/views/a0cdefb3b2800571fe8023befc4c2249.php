...
<form method="POST" action="<?php echo e(route('admin.bookmarks.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="dm-table-wrap" style="padding:24px;">
                <div class="dm-form-group">
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="dm-form-input" placeholder="e.g. Follow us on LinkedIn" required>
                    <div class="dm-form-hint">Displayed as the button label on the page.</div>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">URL *</label>
                    <input type="url" name="url" value="<?php echo e(old('url')); ?>" class="dm-form-input" placeholder="https://..." required>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Description</label>
                    <input type="text" name="description" value="<?php echo e(old('description')); ?>" class="dm-form-input" placeholder="Short tagline shown below the button">
                    <div class="dm-form-hint">Optional. Max 255 characters.</div>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Icon (FontAwesome class)</label>
                    <input type="text" name="icon" value="<?php echo e(old('icon')); ?>" class="dm-form-input" placeholder="e.g. fa-brands fa-linkedin">
            ...
            <div class="dm-table-wrap" style="padding:24px;">
                <div class="dm-form-group">
                    ...
                    <div class="dm-form-check" style="margin-top:8px;">
                        <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', '1') == '1' ? 'checked' : ''); ?>>
                ...
                <div class="dm-form-group">
                    ...
                    <input type="number" name="sort_order" value="<?php echo e(old('sort_order', 0)); ?>" class="dm-form-input" min="0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\bookmarks\create.blade.php ENDPATH**/ ?>