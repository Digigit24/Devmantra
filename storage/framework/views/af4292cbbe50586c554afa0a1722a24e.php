...
<form method="POST" action="<?php echo e(route('admin.blogs.update', $blog)); ?>" enctype="multipart/form-data">
        ...
        <div class="col-lg-8">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <textarea name="content" id="contentInput" style="display:none"><?php echo e(old('content', $blog->content)); ?></textarea>
    ...
    <div class="mt-4">
        <?php echo $__env->make('admin.partials._seo-panel', ['model' => $blog], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</form>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\blogs\edit.blade.php ENDPATH**/ ?>