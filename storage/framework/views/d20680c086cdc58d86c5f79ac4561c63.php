<?php $__env->startSection('title', 'Blog - DevMantra'); ?>
<?php $__env->startSection('meta_description', 'Stay ahead with expert perspectives on corporate governance, financial strategy, and business growth.'); ?>
...
<style>
    ...
    .dm-blog-featured-thumb img { width: 100%; height: auto; aspect-ratio: 3 / 2; object-fit: cover; object-position: center center; border-radius: 12px; display: block; }
    ...
    .dm-blog-card-thumb img { width: 100%; height: auto; aspect-ratio: 16 / 9; object-fit: cover; object-position: center center; border-radius: 12px; display: block; }
...
<div class="dm-blog-grid">
    <div class="container container-1230">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="dm-blog-featured-content tp_fade_anim" data-delay=".5">
                        ...
                        <p class="dm-blog-card-excerpt"><?php echo e(Str::limit($featured->clean_excerpt, 160)); ?></p>
                        <span class="dm-blog-card-meta mb-20" style="display:block;"><?php echo e($featured->published_at?->format('M d, Y')); ?></span>
                        <div>
                            <a href="<?php echo e(route('blog.show', $featured->slug)); ?>" class="dm-blog-card-link">
                                Read Article
                ...
                <div class="dm-blog-card tp_fade_anim" data-delay=".<?php echo e(3 + $loop->index); ?>">
                    <div class="dm-blog-card-thumb">
                        <a href="<?php echo e(route('blog.show', $blog->slug)); ?>">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('assets/img/home-13/blog/blog-thumb-' . (($loop->index % 3) + 1) . '.jpg')); ?>" alt="<?php echo e($blog->title); ?>">
                            <?php endif; ?>
                        </a>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:16px 0 8px;">
                        <span class="dm-blog-card-category" style="margin:0;"><?php echo e($blog->category); ?></span>
                        <span class="dm-card-read-time-badge">
                            <i class="fa-regular fa-clock"></i>
                    ...
                    <p class="dm-blog-card-excerpt"><?php echo e(Str::limit($blog->clean_excerpt, 120)); ?></p>
                    <span class="dm-blog-card-meta"><?php echo e($blog->published_at?->format('M d, Y')); ?></span>
                </div>
            </div>
        ...
        <?php if($blogs->hasPages()): ?>
            <?php echo e($blogs->links('vendor.pagination.devmantra')); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\frontend\blog-index.blade.php ENDPATH**/ ?>