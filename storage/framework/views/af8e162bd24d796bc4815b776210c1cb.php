...
<form method="POST" action="<?php echo e(route('admin.careers.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
        <div class="col-lg-8">
        ...
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="location" value="<?php echo e(old('location')); ?>" class="dm-form-input" placeholder="e.g. Bengaluru, India">
                </div>
                <div class="dm-form-group">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Devmantranew\resources\views\admin\careers\create.blade.php ENDPATH**/ ?>