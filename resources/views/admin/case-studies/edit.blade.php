        ...
        <div class="col-lg-8">
            <div class="dm-table-wrap" style="padding:24px;">
                <div class="dm-form-group">
                    ...
                    <input type="text" name="title" value="{{ old('title', $caseStudy->title) }}" class="dm-form-input" required>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Slug</label>
                    <input type="text" name="slug" value="{{ old('slug', $caseStudy->slug) }}" class="dm-form-input">
                    <div class="dm-form-hint">Permalink: {{ url('/case-study/' . $caseStudy->slug) }}</div>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Excerpt</label>
                    <textarea name="excerpt" class="dm-form-textarea" style="min-height:80px;">{{ old('excerpt', $caseStudy->excerpt) }}</textarea>
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Content *</label>
                    <textarea name="content" class="summernote" required>{{ old('content', $caseStudy->content) }}</textarea>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="category" value="{{ old('category', $caseStudy->category) }}" class="dm-form-input">
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Read Time</label>
                    <input type="text" name="read_time" value="{{ old('read_time', $caseStudy->read_time) }}" class="dm-form-input" placeholder="e.g. 8 min read">
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Publish Date</label>
                    <input type="datetime-local" name="published_at" value="{{ old('published_at', $caseStudy->published_at?->format('Y-m-d\TH:i')) }}" class="dm-form-input">
                ...
                <div class="dm-form-group">
                    ...
                    @if($caseStudy->featured_image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $caseStudy->featured_image) }}" style="width:100%;border-radius:8px;max-height:160px;object-fit:cover;" alt="">
                        </div>
                    @endif
                ...
                <div class="dm-form-group">
                    ...
                    <textarea name="meta_description" class="dm-form-textarea" style="min-height:60px;">{{ old('meta_description', $caseStudy->meta_description) }}</textarea>
                </div>
                <div class="dm-form-group">
