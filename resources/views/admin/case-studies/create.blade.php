        ...
        <div class="col-lg-4">
            <div class="dm-table-wrap" style="padding:24px;">
                ...
                <div class="dm-form-group">
                    ...
                    <input type="text" name="category" value="{{ old('category', 'Case Study') }}" class="dm-form-input">
                </div>
                <div class="dm-form-group">
                    <label class="dm-form-label">Read Time</label>
                    <input type="text" name="read_time" value="{{ old('read_time') }}" class="dm-form-input" placeholder="e.g. 8 min read">
                </div>
                <div class="dm-form-group">
