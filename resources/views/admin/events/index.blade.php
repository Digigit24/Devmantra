    ...
    <table class="dm-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- Tags inline toggle --}}
                <td>
                    <div class="ev-tag-pills" id="tags-{{ $event->id }}">
                        @foreach(\App\Models\Event::TAGS as $tval => $tlabel)
                        @php $active = in_array($tval, $event->tags ?? []); @endphp
                        <span class="ev-tag-pill t-{{ $tval }} {{ $active ? 'on' : 'off' }}"
                              onclick="evTagToggle({{ $event->id }}, '{{ $tval }}', this)">
                            {{ $tlabel }}
                        </span>
                        @endforeach
                    </div>
