            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="cr-brand-heading text-center mb-60">
                        <div class="ca-brand-sub mb-70">
                            <img src="{{ asset('assets/img/home-13/brand/brand-sub.png') }}" alt="" loading="lazy">
                        </div>
                ...
                <div class="col-lg-8">
                            ...
                            <div class="swiper-wrapper slider-transtion">
                                ...
                                <div class="swiper-slide">
                                    <div class="app-brand-item">
                                        <img src="{{ asset('assets/img/logo/'.$i.'.png') }}" alt="" loading="lazy">
                                    </div>
                                </div>
                                @endfor
                            </div>
                    ...
                    <div class="cr-brand-bottom">
                        <img src="{{ asset('assets/img/home-13/brand/brand-bottom.png') }}" alt="" loading="lazy">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="dm-values-grid">
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/1.png') }}" alt="" loading="lazy"></div>
                            <h5>Trust</h5>
                        ...
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/2.png') }}" alt="" loading="lazy"></div>
                            <h5>Transparency</h5>
                        ...
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/3.png') }}" alt="" loading="lazy"></div>
                            <h5>Integrity</h5>
                        ...
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/4.png') }}" alt="" loading="lazy"></div>
                        ...
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/5.png') }}" alt="" loading="lazy"></div>
                            <h5>Excellence</h5>
                        ...
                        <div class="dm-value-card">
                            <div class="dm-value-icon"><img src="{{ asset('assets/img/logo/icon/6.png') }}" alt="" loading="lazy"></div>
