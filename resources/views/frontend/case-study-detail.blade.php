            ...
            <div class="col-lg-8">
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        <a href="{{ route('case-study.index') }}">{{ $caseStudy->category }}</a>
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($caseStudy->title) }}" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
                    ...
                    <div class="dm-sidebar-post">
                        ...
                        <div class="dm-sidebar-post-info">
                            ...
                            <h5 class="dm-sidebar-post-title">
                                <a href="{{ route('case-study.show', $sidePost->slug) }}">{{ $sidePost->title }}</a>
                            </h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-related-card tp_fade_anim" data-delay=".{{ 3 + ($loop->index * 2) }}">
                    ...
                    <h4 class="dm-related-card-title">
                        <a href="{{ route('case-study.show', $post->slug) }}">{{ $post->title }}</a>
                    </h4>
                </div>
            </div>
            @endforeach
