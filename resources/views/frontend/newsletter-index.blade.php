                ...
                <div class="col-lg-6">
                    <div class="dm-newsletter-featured-content tp_fade_anim" data-delay=".5">
                        ...
                        <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;">
                            ...
                            <a href="{{ $featured->button_url }}" target="_blank" rel="noopener noreferrer" class="dm-newsletter-read-more-btn">
                                {{ $featured->button_text ?: 'Read More' }} <i class="fa-solid fa-arrow-up-right-from-square"></i>
                            </a>
                            @endif
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-edition-card tp_fade_anim" data-delay=".{{ 3 + ($loop->index % 3) }}">
                    ...
                    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                        ...
                        <a href="{{ $newsletter->button_url }}" target="_blank" rel="noopener noreferrer" class="dm-newsletter-read-more-btn">
                            {{ $newsletter->button_text ?: 'Read More' }} <i class="fa-solid fa-arrow-up-right-from-square"></i>
                        </a>
                        @endif
                    </div>
                </div>
