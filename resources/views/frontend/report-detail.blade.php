    ...
    <div class="container container-1230">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                @if($report->button_url)
                <div style="margin:40px 0 0;">
                    <a href="{{ $report->button_url }}" target="_blank" rel="noopener noreferrer" style="
                ...
                <div class="dm-article-footer">
                    <div class="dm-article-tags">
                        ...
                        @if($report->edition_label)
                        <a href="{{ route('report.index') }}">{{ $report->edition_label }}</a>
                        @endif
                    </div>
                    <div class="dm-article-share">
                        <span>Share</span>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($report->title) }}" target="_blank" rel="noopener" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <!--        @foreach($sidebarReports as $sidePost)-->
            ...
            <!--                    {{ $sidePost->edition_label ?? 'Report' }}-->
            <!--                </span>-->
            <!--                <h5 class="dm-sidebar-post-title">-->
            <!--                    <a href="{{ route('report.show', $sidePost->slug) }}">{{ $sidePost->title }}</a>-->
            <!--                </h5>-->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-related-card tp_fade_anim" data-delay=".{{ 3 + ($loop->index * 2) }}">
                    <div class="dm-related-card-thumb">
                        <a href="{{ route('report.show', $post->slug) }}">
                    ...
                    <span class="dm-related-card-category">{{ $post->edition_label ?? 'Report' }}</span>
                    <h4 class="dm-related-card-title">
                        <a href="{{ route('report.show', $post->slug) }}">{{ $post->title }}</a>
                    </h4>
                </div>
            </div>
            @endforeach
