...
@section('title', 'India vs Europe Manufacturing Cost Calculator — DevMantra')
@section('meta_description', 'Compare India vs Europe manufacturing costs with real-time freight, duty and FX rates. Landed cost analysis with 2025-26 benchmark data.')
...
{{-- ═══ HERO ════════════════════════════════════════════════════════════════ --}}
<div class="cc-hero">
    {{-- FX fallback banner sits at hero bottom, full-width --}}
    ...
    <div class="cc-hero-inner">
        <div class="cc-hero-left">
            <div>
                ...
                {{-- #17 FIX: "2025 Data" → dynamic year tag --}}
...
<div class="cc-wiz-outer" id="wizOuter">
    ...
    <div class="cc-wiz-card">
        ...
        <div class="cc-step active" id="step-1">
            ...
            <div class="cc-step-body">
                ...
                <div class="cc-fg">
                    ...
                    {{-- #07 FIX: labels corrected for 8467 (PIR), 2106 (varies), 7228 (range) --}}
                    ...
                    {{-- #07 FIX: universal BCD disclaimer --}}
        ...
        <div class="cc-step" id="step-2">
            ...
            <div class="cc-step-body">
                ...
                {{-- #02 FIX: Two separate RM cost fields; saving% is derived read-only --}}
        ...
        <div class="cc-step" id="step-3">
            ...
            <div class="cc-step-body">
                ...
                {{-- #03 FIX: India Manufacturing Region selector --}}
                <div class="cc-fg">
                ...
                <div class="cc-fg">
                    ...
                    {{-- #02 FIX: rates recalculated at 110.92; no FIX# badge --}}
                ...
                <div class="cc-row2">
                    ...
                    <div class="cc-fg">
                        {{-- #08 FIX: overhead auto-set per country; no longer a single global default --}}
        ...
        <div class="cc-step" id="step-4">
            ...
            <div class="cc-step-body">
                {{-- #06 FIX: FCL mode + container fill rate for dynamic per-kg calc --}}
                <div class="cc-fg">
                    <label class="cc-label">Logistics Mode</label>
                    {{-- #14 FIX: air freight citation updated to 2025-26 --}}
                ...
                {{-- #05 FIX: SWS + IGST rate + Indian entity toggle --}}
        ...
        <div class="cc-step" id="step-6">
            ...
            <div class="cc-step-body">
                ...
                {{-- #10 FIX: slider explicitly updates Annual Savings KPI --}}
    ...
    {{-- API Logs — visible by default (#11 FIX); #16 FIX: no debug labels --}}
    <div id="apiLogsWrap">
    ...
    {{-- #17 FIX: Book a Discovery Call (single L, correct spelling) --}}
