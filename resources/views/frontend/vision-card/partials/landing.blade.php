{{--
    Growth Blueprint — redesigned landing experience.
    Converted from the Open Design prototype (index.html / style.css / script.js).
    Lives inside #screen-hero — the first screen of the existing single-page
    Vision Card state machine. All CTAs call the existing startJourney()
    global (see public/assets/vision-card/js/main.js) instead of navigating
    away, so the questionnaire that follows is completely unchanged.
--}}
<div class="vc-landing" id="vcLanding">
  ...
  <header class="nav" id="vclNav">
    <div class="container nav__inner">
      <a href="#hero" class="nav__brand" aria-label="Dev Mantra home">
        <img class="nav__logo" src="{{ asset('assets/img/logo/logo.jpeg') }}" alt="Dev Mantra">
      </a>
  ...
  <footer class="footer">
    <div class="container footer__inner">
      ...
      <p class="footer__copy">© <span id="vclYear">{{ date('Y') }}</span> Dev Mantra. All rights reserved.</p>
    </div>
  </footer>
