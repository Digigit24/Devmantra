...
@section('title', 'Case Studies - DevMantra')
@section('meta_description', 'Explore our in-depth case studies on financial strategy, regulatory impact, and business advisory.')
...
<style>
    ...
    .dm-blog-featured-thumb img { width: 100%; height: auto; aspect-ratio: 16 / 9; object-fit: cover; border-radius: 12px; }
    ...
    .dm-blog-card-thumb img { width: 100%; height: auto; aspect-ratio: 16 / 9; object-fit: cover; border-radius: 12px; }
...
<div class="dm-blog-grid">
    <div class="container container-1230">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="dm-blog-featured-thumb tp_fade_anim" data-delay=".3">
                        <a href="{{ route('case-study.show', $featured->slug) }}">
                ...
                <div class="col-lg-6">
                    <div class="dm-blog-featured-content tp_fade_anim" data-delay=".5">
                        ...
                        <h3 class="dm-blog-featured-title">
                            <a href="{{ route('case-study.show', $featured->slug) }}">{{ $featured->title }}</a>
                        </h3>
                        ...
                        <div>
                            <a href="{{ route('case-study.show', $featured->slug) }}" class="dm-blog-card-link">
                                Read Case Study
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dm-blog-card tp_fade_anim" data-delay=".{{ 3 + $loop->index }}">
                    <div class="dm-blog-card-thumb">
                        <a href="{{ route('case-study.show', $item->slug) }}">
        ...
        @if($caseStudies->hasPages())
            {{ $caseStudies->links('vendor.pagination.devmantra') }}
        @endif
    </div>
</div>
@endsection
