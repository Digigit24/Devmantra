...
<div class="bm-wrap">
    ...
    <div class="bm-header">
        <div class="bm-logo-wrap">
            <img src="{{ asset('assets/img/logo/logo.jpeg') }}" alt="DevMantra Logo">
        </div>
        ...
        <div class="bm-socials">
            ...
            <a href="{{ route('home') }}" class="bm-social-btn" title="Website">
    ...
    <div class="bm-links">
        ...
        <a href="{{ $bookmark->url }}" target="_blank" rel="noopener" class="bm-link">
            @if($bookmark->icon)
            <span class="bm-link-icon"><i class="{{ $bookmark->icon }}"></i></span>
            @else
            <span class="bm-link-icon"><i class="fa-solid fa-arrow-up-right-from-square"></i></span>
            @endif
            <div class="bm-link-body">
                <div class="bm-link-title">{{ $bookmark->title }}</div>
                @if($bookmark->description)
                <div class="bm-link-desc">{{ $bookmark->description }}</div>
                @endif
            </div>
    ...
    <!-- Footer -->
    <div class="bm-footer">
        <a href="{{ route('home') }}">devmantra.in</a>
        &nbsp;·&nbsp; &copy; {{ date('Y') }} DevMantra
    </div>
