        ...
        <tr>
          <td style="background:#ffffff;padding:40px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e8ecf0;border-radius:10px;overflow:hidden;">
              <tr>
                ...
                <td style="background:#ffffff;padding:14px 20px;border-bottom:1px solid #e8ecf0;">
                  <span style="font-size:15px;color:#1a1a2e;font-weight:500;">{{ $name }}</span>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:#ffffff;padding:14px 20px;border-bottom:1px solid #e8ecf0;">
                  <a href="mailto:{{ $email }}" style="font-size:15px;color:#4a73c4;text-decoration:none;font-weight:500;">{{ $email }}</a>
                </td>
              </tr>
              @if($phone)
              <tr>
                ...
                <td style="background:#ffffff;padding:14px 20px;border-bottom:1px solid #e8ecf0;">
                  <span style="font-size:15px;color:#1a1a2e;font-weight:500;">{{ $phone }}</span>
                </td>
              </tr>
              @endif
              <tr>
                ...
                <td style="background:#ffffff;padding:14px 20px;border-bottom:1px solid #e8ecf0;">
                  <span style="font-size:15px;color:#1a1a2e;font-weight:500;">{{ $enquirySubject }}</span>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:#ffffff;padding:14px 20px;">
                  <span style="font-size:15px;color:#333;line-height:1.7;white-space:pre-line;">{{ $userMessage }}</span>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;">
              <tr>
                <td align="center">
                  <a href="mailto:{{ $email }}?subject=Re: {{ $enquirySubject }}" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#1b3c6b,#4a73c4);color:#ffffff;text-decoration:none;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.2px;">
                    Reply to {{ $name }}
                  </a>
                </td>
              </tr>
