  ...
  var headerCSS = `
    <style>
        ...
        @media (min-width: 1400px) and (max-width: 1599px) {
            ...
            .tp-header-menu > nav > ul > li > a { font-size: 15px; }
            .tp-header-btn-box .tp-btn-white-border { font-size: 14px; padding: 12px 20px; }
        }
            ...
            <div class="tp-offcanvas-top d-flex align-items-center justify-content-between">
                <div class="tp-offcanvas-logo">
                    <a href="${basePath}index.html">
                        <img class="logo-1" data-width="120" src="${basePath}assets/img/logo/logo-black.png" alt="Dev Mantra">
                        <img class="logo-2" data-width="120" src="${basePath}assets/img/logo/logo-white.png" alt="Dev Mantra">
                    </a>
                </div>
                    ...
                    <div class="col-xl-2 col-lg-5 col-5">
                        <div class="tp-header-logo">
                            <a href="${basePath}index.html"><img style="border-radius: 50px;" data-width="140"
                                    src="${basePath}assets/img/logo/logo.jpeg" alt="Dev Mantra"></a>
                        </div>
                    </div>
